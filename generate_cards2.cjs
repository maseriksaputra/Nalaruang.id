const fs = require('fs');
const cards = [
    { id: '01', color: 'rose', title: 'Cetak Fisik Premium', link: '/layanan/cetak-fisik', populer: false, icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"></path>', items: ['Undangan Pernikahan Eksklusif', 'Custom Lanyard & ID Card', 'Buku Yasin & Majmu Premium', 'Jasa Print & Fotocopy Dokumen'] },
...
cards.forEach((c, i) => {
    ...
    if(c.color === 'rose') dotColor = '#fda4af';
    ...
    html += `
                ...
                <div class="group relative bg-white p-6 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] hover:-translate-y-2 transition-all duration-500 border border-gray-100 flex flex-col overflow-hidden h-full cursor-pointer" data-aos="fade-up" data-aos-delay="${delay}">
                    ...
                    <div class="text-left relative z-10 flex-grow flex flex-col">
                        <h3 class="text-xl font-serif font-bold text-gray-900 mb-5 group-hover:text-${c.color}-800 transition-colors duration-300">${c.title}</h3>
...
html += '\n            </div>';
fs.writeFileSync('d:/laragon/www/Undangan/cards2.html', html);
