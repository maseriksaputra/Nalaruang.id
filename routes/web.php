...
Route::get('/debug-cashflow', function () {
    ...
    // Simulate what CashflowStats does
    ...
    // Simulate what CashflowLineChart does
    ...
    // Simulate what ListCashflows does (pagination)
    ...
    return [
        ...
        'total_time_ms' => round(($timeStats + $timeChart + $timeRecords) * 1000, 2),
        'queries' => $queries
    ];
});
