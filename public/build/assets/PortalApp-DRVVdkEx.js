...
var Surface = /*#__PURE__*/ (0, import_react.forwardRef)((props, ref) => {
	var { children, width, height, viewBox, className, style, title, desc } = props, others = _objectWithoutProperties$21(props, _excluded$21);
	var svgView = viewBox || {
		width,
		height,
		x: 0,
...
var Layer = /*#__PURE__*/ import_react.forwardRef((props, ref) => {
	var { children, className } = props, others = _objectWithoutProperties$20(props, _excluded$20);
...
var Symbols = (_ref) => {
	...
	var props = _objectSpread$42(_objectSpread$42({}, _objectWithoutProperties$19(_ref, _excluded$19)), {}, {
		type,
		size,
		sizeType
	});
...
function matchesProperty(property, source) {
	...
	return function(target) {
		...
		if (result === void 0) return has$1(target, property);
...
function uniqBy(array, iteratee$1 = identity$2) {
...
var require_with_selector$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var import_with_selector$1 = require_with_selector$1();
...
var Cross = (_ref) => {
	var { x = 0, y = 0, top = 0, left = 0, width = 0, height = 0, className } = _ref, rest = _objectWithoutProperties$18(_ref, _excluded$18);
...
*/
var _excluded$17 = ["radius"], _excluded2$9 = ["radius"];
...
var Rectangle = (rectangleProps) => {
	...
	if (!isUpdateAnimationActive) {
		var _svgPropertiesAndEven = svgPropertiesAndEvents(props), { radius: _ } = _svgPropertiesAndEven, otherPathProps = _objectWithoutProperties$17(_svgPropertiesAndEven, _excluded$17);
	...
	return /*#__PURE__*/ import_react.createElement(JavascriptAnimate, {
		...
		var _svgPropertiesAndEven2 = svgPropertiesAndEvents(props), { radius: _ } = _svgPropertiesAndEven2, otherPathProps = _objectWithoutProperties$17(_svgPropertiesAndEven2, _excluded2$9);
		return /*#__PURE__*/ import_react.createElement("path", _extends$18({}, otherPathProps, {
			radius: typeof radius === "number" ? radius : void 0,
			className: layerClass,
...
var computeDomainOfTypeCategory = (allDataSquished, axisSettings, isCategorical) => {
	...
	if (isCategorical && (axisSettings.dataKey == null || axisSettings.allowDuplicatedCategory && hasDuplicate(categoricalDomain))) return range$1(0, allDataSquished.length);
		...
		var listener = (incomingSyncId, action, emitter) => {
			...
			if (syncMethod === "index") {
				...
				if (viewBox && action !== null && action !== void 0 && (_action$payload = action.payload) !== null && _action$payload !== void 0 && _action$payload.coordinate && action.payload.sourceViewBox) {
					var _action$payload$coord = action.payload.coordinate, { x: _x, y: _y } = _action$payload$coord, otherCoordinateProps = _objectWithoutProperties$16(_action$payload$coord, _excluded$16);
...
var Text = /*#__PURE__*/ (0, import_react.forwardRef)((outsideProps, ref) => {
	var _resolveDefaultProps = resolveDefaultProps(outsideProps, textDefaultProps), { x: propsX, y: propsY, lineHeight, capHeight, fill, scaleToFit, textAnchor, verticalAnchor } = _resolveDefaultProps, props = _objectWithoutProperties$15(_resolveDefaultProps, _excluded$15);
	...
	var { dx, dy, angle, className, breakAll } = props, textProps = _objectWithoutProperties$15(props, _excluded2$8);
...
var _excluded$14 = ["labelRef"], _excluded2$7 = ["content"];
...
function Label(outerProps) {
	...
	if (/*#__PURE__*/ (0, import_react.isValidElement)(content)) {
		...
		return /*#__PURE__*/ (0, import_react.cloneElement)(content, _objectWithoutProperties$14(propsWithViewBox, _excluded$14));
	}
	if (typeof content === "function") {
		var { content: _2 } = propsWithViewBox;
		label = /*#__PURE__*/ (0, import_react.createElement)(content, _objectWithoutProperties$14(propsWithViewBox, _excluded2$7));
...
function LabelList(_ref) {
	var { valueAccessor = defaultAccessor } = _ref, restProps = _objectWithoutProperties$13(_ref, _excluded$13);
	var { dataKey, clockWise, id, textBreakAll, zIndex } = restProps, others = _objectWithoutProperties$13(restProps, _excluded2$6);
...
function Shape(_ref2) {
	var { option, shapeType, activeClassName = "recharts-active-shape", inActiveClassName = "recharts-shape" } = _ref2, props = _objectWithoutProperties$12(_ref2, _excluded$12);
	var shape;
...
var _excluded$11 = ["key"], _excluded2$5 = [
	"onMouseEnter",
	"onClick",
	"onMouseLeave"
], _excluded3$4 = ["id"], _excluded4$1 = ["id"];
...
var renderLabelLineItem = (option, props) => {
	...
	var { key } = props, otherProps = _objectWithoutProperties$11(props, _excluded$11);
...
function PieSectors(props) {
	...
	var activeGraphicalItemId = useAppSelector(selectActiveTooltipGraphicalItemId);
	var { onMouseEnter: onMouseEnterFromProps, onClick: onItemClickFromProps, onMouseLeave: onMouseLeaveFromProps } = allOtherPieProps, restOfAllOtherProps = _objectWithoutProperties$11(allOtherPieProps, _excluded2$5);
...
function PieImpl(props) {
	var { id } = props, propsWithoutId = _objectWithoutProperties$11(props, _excluded3$4);
...
function PieFn(outsideProps) {
	...
	var { id: externalId } = props, propsWithoutId = _objectWithoutProperties$11(props, _excluded4$1);
...
var _excluded$8 = [
	...
	"y2",
	"key"
], _excluded2$4 = ["offset"], _excluded3$3 = ["xAxisId", "yAxisId"], _excluded4 = ["xAxisId", "yAxisId"];
...
function VerticalGridLines(props) {
	...
	var { xAxisId, yAxisId } = props, otherLineItemProps = _objectWithoutProperties$8(props, _excluded4);
...
function LineDotsWrapper(_ref2) {
	...
	var { id } = props;
	var lineProps = svgPropertiesNoEvents(_objectWithoutProperties$6(props, _excluded$6));
...
function StaticCurve(_ref4) {
	...
	var curveProps = _objectSpread$6(_objectSpread$6({}, svgPropertiesAndEvents(_objectWithoutProperties$6(props, _excluded2$3))), {}, {
		fill: "none",
	...
	return /*#__PURE__*/ import_react.createElement(LineLabelListProvider, {
		...
		if (prevPoints) {
			...
			var stepData = t === 1 ? points : points.map((entry, index) => {
				...
				if (animateNewValues) return _objectSpread$6(_objectSpread$6({}, entry), {}, {
...
//#endregion
//#region resources/js/Dashboard/PortalApp.jsx
var import_client = require_client();
var import_jsx_runtime = require_jsx_runtime();
var MobilePreview = ({ slug, title }) => {
	...
	import_react.useEffect(() => {
		...
		const observer = new ResizeObserver((entries) => {
			for (let entry of entries) setScale(entry.contentRect.width / 414);
		});
		observer.observe(containerRef.current);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		ref: containerRef,
		className: "absolute inset-0 w-full h-full flex items-start justify-center overflow-hidden bg-gray-900",
...
var PortalApp = () => {
	...
	const [rsvps, setRsvps] = (0, import_react.useState)([]);
	const [guestLinks, setGuestLinks] = (0, import_react.useState)([]);
	const [selectedInvitation, setSelectedInvitation] = (0, import_react.useState)("");
	const [newGuestName, setNewGuestName] = (0, import_react.useState)("");
	const [bulkGuestNames, setBulkGuestNames] = (0, import_react.useState)("");
	const [waGreeting, setWaGreeting] = (0, import_react.useState)("");
	const [publishStatus, setPublishStatus] = (0, import_react.useState)("draft");
	const [publishDuration, setPublishDuration] = (0, import_react.useState)("1_month");
	const [isPublishing, setIsPublishing] = (0, import_react.useState)(false);
	const [orders, setOrders] = (0, import_react.useState)([]);
	const [activeTab, setActiveTab] = (0, import_react.useState)("beranda");
	const [activeFolder, setActiveFolder] = (0, import_react.useState)(null);
	const [dbFolders, setDbFolders] = (0, import_react.useState)([]);
	...
	const handleCreateFolder = async () => {
		...
		try {
			...
			if ((await axios.post("/admin/invitation-portal/template-folders", { name: name.trim() }, { headers: { "X-CSRF-TOKEN": csrfToken } })).data.success) {
				fetchDbFolders();
	...
	const handleThumbnailUpload = async (templateId, file) => {
		...
		try {
			const csrfToken = document.querySelector("meta[name=\"csrf-token\"]")?.getAttribute("content");
			const res = await axios.post(`/admin/invitation-portal/templates/${templateId}/thumbnail`, formData, { headers: {
				"X-CSRF-TOKEN": csrfToken,
				"Content-Type": "multipart/form-data"
			} });
			setTemplates(templates.map((t) => t.id === templateId ? {
				...t,
				thumbnail_path: res.data.thumbnail_url
			} : t));
	...
	const handleCreateLink = async (e) => {
		...
		try {
			const csrfToken = document.querySelector("meta[name=\"csrf-token\"]")?.getAttribute("content");
			await axios.post(`/admin/invitation-portal/${selectedInvitation}/links`, { guest_name: newGuestName }, { headers: { "X-CSRF-TOKEN": csrfToken } });
			setNewGuestName("");
	...
	const handleWhatsAppShare = (link) => {
		...
		let message = waGreeting ? waGreeting.replace(/\[NAMA_TAMU\]/g, link.guest_name).replace(/\[LINK_UNDANGAN\]/g, url) : `Kepada Yth. ${link.guest_name},\n\nKami mengundang Bapak/Ibu/Saudara/i untuk hadir di acara pernikahan kami.\n\nBuka undangan di sini:\n${url}\n\nTerima kasih.`;
		if (waGreeting && !waGreeting.includes("[LINK_UNDANGAN]")) message += `\n\nLink Undangan: ${url}`;
	...
	const handleBatchCreateLinks = async (e) => {
		...
		try {
			...
			const csrfToken = document.querySelector("meta[name=\"csrf-token\"]")?.getAttribute("content");
			await axios.post(`/admin/invitation-portal/${selectedInvitation}/links/batch`, { guest_names: names }, { headers: { "X-CSRF-TOKEN": csrfToken } });
			setBulkGuestNames("");
			fetchGuestLinks(selectedInvitation);
		} catch (error) {
	...
	const handleSaveGreeting = async () => {
		...
		try {
			const csrfToken = document.querySelector("meta[name=\"csrf-token\"]")?.getAttribute("content");
			await axios.post(`/admin/invitation-portal/${selectedInvitation}/greeting`, { whatsapp_greeting: waGreeting }, { headers: { "X-CSRF-TOKEN": csrfToken } });
			setInvitations(invitations.map((inv) => inv.id == selectedInvitation ? {
				...inv,
				whatsapp_greeting: waGreeting
			} : inv));
	...
	const handlePublishSubmit = async () => {
		...
		try {
			const csrfToken = document.querySelector("meta[name=\"csrf-token\"]")?.getAttribute("content");
			const data = await (await fetch(`/admin/builder/${selectedInvitation}/publish`, {
				method: "POST",
				headers: {
	...
	(0, import_react.useEffect)(() => {
		const fetchInvitations = async () => {
			try {
				...
				if (idParam && tabParam === "distribusi") {
					...
					setWaGreeting(invData.find((i) => i.id == idParam)?.whatsapp_greeting || `Kepada Yth. [NAMA_TAMU],\n\nKami mengundang Bapak/Ibu/Saudara/i untuk hadir di acara pernikahan kami.\n\nBuka undangan di sini:\n[LINK_UNDANGAN]\n\nTerima kasih.`);
				}
			} catch (error) {
		...
		const fetchStatistics = async () => {
			try {
				setStatistics((await axios.get("/admin/invitation-portal/statistics")).data);
			} catch (error) {
	...
	const handleRename = async (e, id, currentTitle) => {
		...
		try {
			const csrfToken = document.querySelector("meta[name=\"csrf-token\"]")?.getAttribute("content");
			await axios.post(`/admin/invitation-portal/${id}/rename`, { title: newTitle.trim() }, { headers: { "X-CSRF-TOKEN": csrfToken } });
			setInvitations(invitations.map((inv) => inv.id === id ? {
				...inv,
				title: newTitle.trim()
			} : inv));
		} catch (error) {
	...
	const handleEditSlug = async (e, id, currentSlug) => {
		e.stopPropagation();
		const newSlug = await window.promptAsync("Masukkan URL / Slug kustom baru (hanya huruf kecil, angka, dan strip):", currentSlug);
		if (!newSlug || !newSlug.trim() || newSlug === currentSlug) return;
		try {
			const csrfToken = document.querySelector("meta[name=\"csrf-token\"]")?.getAttribute("content");
			await axios.post(`/admin/invitation-portal/${id}/slug`, { slug: newSlug.trim().toLowerCase() }, { headers: { "X-CSRF-TOKEN": csrfToken } });
			setInvitations(invitations.map((inv) => inv.id === id ? {
				...inv,
				slug: newSlug.trim().toLowerCase()
			} : inv));
			alert("URL berhasil diubah!");
		} catch (error) {
			console.error(error);
			const msg = error.response?.data?.message || "Gagal mengubah URL. Pastikan formatnya benar dan belum dipakai oleh orang lain.";
			alert(msg);
		}
	};
	const handleDelete = async (e, id) => {
		...
		try {
			const csrfToken = document.querySelector("meta[name=\"csrf-token\"]")?.getAttribute("content");
			await axios.delete(`/admin/invitation-portal/${id}`, { headers: { "X-CSRF-TOKEN": csrfToken } });
	...
	const handleUpdateOrderStatus = async (id, newStatus) => {
		try {
			const csrfToken = document.querySelector("meta[name=\"csrf-token\"]")?.getAttribute("content");
			await axios.post(`/admin/invitation-portal/orders/${id}/status`, { status: newStatus }, { headers: { "X-CSRF-TOKEN": csrfToken } });
	...
	const handleGenerateOrderForm = async (id) => {
		try {
			const csrfToken = document.querySelector("meta[name=\"csrf-token\"]")?.getAttribute("content");
			const res = await axios.post(`/admin/invitation-portal/orders/${id}/generate-form`, {}, { headers: { "X-CSRF-TOKEN": csrfToken } });
			if (res.data.success) {
				setOrders(orders.map((order) => order.id === id ? {
					...order,
					form_token: res.data.form_token
				} : order));
	...
	const handleGenerateOrderProject = async (id) => {
		try {
			const csrfToken = document.querySelector("meta[name=\"csrf-token\"]")?.getAttribute("content");
			const res = await axios.post(`/admin/invitation-portal/orders/${id}/generate-project`, {}, { headers: { "X-CSRF-TOKEN": csrfToken } });
			if (res.data.success && res.data.redirect_url) window.location.href = res.data.redirect_url;
		} catch (error) {
			console.error(error);
	...
	const handleDeleteOrder = async (id) => {
		...
		try {
			const csrfToken = document.querySelector("meta[name=\"csrf-token\"]")?.getAttribute("content");
			await axios.delete(`/admin/invitation-portal/orders/${id}`, { headers: { "X-CSRF-TOKEN": csrfToken } });
	...
	const handleRenameOrder = async (id, currentName) => {
		...
		try {
			const csrfToken = document.querySelector("meta[name=\"csrf-token\"]")?.getAttribute("content");
			await axios.post(`/admin/invitation-portal/orders/${id}/rename`, { customer_name: newName.trim() }, { headers: { "X-CSRF-TOKEN": csrfToken } });
			setOrders(orders.map((order) => order.id === id ? {
				...order,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "min-h-screen bg-white dark:bg-[#0f172a] text-gray-900 dark:text-white flex flex-col font-sans",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			className: "h-20 flex items-center justify-between px-8 border-b border-[#1e293b] bg-white dark:bg-[#0f172a]/90 backdrop-blur sticky top-0 z-50",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "flex items-center gap-2",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
					src: "/logo.png",
					alt: "Nalaruang.id",
					className: "h-14 md:h-16 w-auto drop-shadow-sm object-contain"
				})
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						className: "p-2.5 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition",
						children: isDarkMode ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
							className: "w-5 h-5",
							fill: "none",
							stroke: "currentColor",
							viewBox: "0 0 24 24",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							className: "w-10 h-10 rounded-full border-2 border-gray-200 dark:border-[#1e293b] bg-gradient-to-tr from-orange-400 to-pink-500 cursor-pointer hover:border-gray-400 transition-colors shadow-sm"
						}), isProfileOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "absolute right-0 mt-3 w-48 bg-white dark:bg-[#1e293b] rounded-xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.3)] py-2 border border-gray-100 dark:border-[#334155] z-[100] animate-fade-in-up",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "px-4 py-2 border-b border-gray-100 dark:border-[#334155] mb-1",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
									href: "/profile",
									className: "flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-blue-50 dark:hover:bg-[#0f172a] hover:text-blue-600 transition-colors",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
										className: "w-4 h-4",
										fill: "none",
										stroke: "currentColor",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
										...
										type: "submit",
										className: "w-full flex items-center gap-2 text-left px-4 py-2.5 text-sm font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors mt-1",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
											className: "w-4 h-4",
											fill: "none",
											stroke: "currentColor",
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("aside", {
				className: "w-64 border-r border-[#1e293b] p-6 hidden md:flex flex-col bg-white dark:bg-[#0f172a] z-40",
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Pesanan" })]
							}), (() => {
								const pendingCount = orders.filter((o) => ["pending", "diproses"].includes(String(o.status).toLowerCase())).length;
								return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: `ml-auto text-xs font-semibold px-2.5 py-0.5 rounded border ${pendingCount > 0 ? "bg-orange-100 text-orange-600 dark:bg-orange-900/30 dark:text-orange-400 border-orange-200 dark:border-orange-800" : "bg-gray-100 text-gray-500 border-gray-200 dark:bg-[#1e293b] dark:text-gray-400 dark:border-gray-700"}`,
				...
				className: "flex-1 p-6 md:p-8 overflow-y-auto bg-gray-50 dark:bg-[#0b1120]",
				children: [
					activeTab === "statistik" && statistics && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
									...
									children: "Statistik Analitik"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-gray-500 dark:text-gray-400",
									children: "Pantau performa dan kunjungan undangan Anda."
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "bg-white dark:bg-[#0f172a] rounded-2xl p-6 border border-gray-100 dark:border-[#1e293b] shadow-sm flex items-center gap-4",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "w-14 h-14 rounded-full bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center text-blue-500",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
												className: "w-7 h-7",
												fill: "none",
												stroke: "currentColor",
											...
											children: "Tamu Disebar"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
											className: "text-2xl font-black text-gray-900 dark:text-white",
											children: statistics.overview.totalGuests
										})] })]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "bg-white dark:bg-[#0f172a] rounded-2xl p-6 border border-gray-100 dark:border-[#1e293b] shadow-sm flex items-center gap-4",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "w-14 h-14 rounded-full bg-emerald-50 dark:bg-emerald-900/20 flex items-center justify-center text-emerald-500",
											...
											className: "text-2xl font-black text-gray-900 dark:text-white",
											children: [
												statistics.overview.totalVisitors,
												" ",
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
													className: "text-xs text-emerald-500 ml-1 font-bold",
													children: [
														"(",
														statistics.overview.engagementRate,
														"%)"
													]
												})
											]
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "bg-white dark:bg-[#0f172a] rounded-2xl p-6 border border-gray-100 dark:border-[#1e293b] shadow-sm flex items-center gap-4",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "w-14 h-14 rounded-full bg-orange-50 dark:bg-orange-900/20 flex items-center justify-center text-orange-500",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
												className: "w-7 h-7",
												fill: "none",
												stroke: "currentColor",
											...
											className: "text-2xl font-black text-gray-900 dark:text-white",
											children: statistics.overview.totalRsvp
										})] })]
									})
								]
							}),
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "bg-white dark:bg-[#0f172a] rounded-xl p-5 border border-indigo-100 dark:border-indigo-900/30 shadow-sm flex flex-col justify-center",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "text-xs font-semibold text-indigo-600 dark:text-indigo-500 uppercase tracking-wider mb-1",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "bg-white dark:bg-[#0f172a] rounded-xl p-5 border border-yellow-100 dark:border-yellow-900/30 shadow-sm flex flex-col justify-center",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "text-xs font-semibold text-yellow-600 dark:text-yellow-500 uppercase tracking-wider mb-1",
											children: "Pending & Proses"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
											className: "text-2xl font-black text-gray-900 dark:text-white",
											children: orders.filter((o) => ["pending", "diproses"].includes(String(o.status).toLowerCase())).length
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "bg-white dark:bg-[#0f172a] rounded-xl p-5 border border-emerald-100 dark:border-emerald-900/30 shadow-sm flex flex-col justify-center",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "text-xs font-semibold text-emerald-600 dark:text-emerald-500 uppercase tracking-wider mb-1",
											children: "Pesanan Selesai"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
											className: "text-2xl font-black text-gray-900 dark:text-white",
											children: orders.filter((o) => ["selesai", "completed"].includes(String(o.status).toLowerCase())).length
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "bg-white dark:bg-[#0f172a] rounded-xl p-5 border border-green-100 dark:border-green-900/30 shadow-sm flex flex-col justify-center",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "text-xs font-semibold text-green-600 dark:text-green-500 uppercase tracking-wider mb-1",
											children: "Total Pendapatan"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
											className: "text-xl sm:text-2xl font-black text-gray-900 dark:text-white",
											children: ["Rp ", new Intl.NumberFormat("id-ID").format(orders.filter((o) => ["selesai", "completed"].includes(String(o.status).toLowerCase())).reduce((acc, order) => acc + (parseFloat(order.total_price) || 0), 0))]
										})]
									})
								]
							}),
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "lg:col-span-2 bg-white dark:bg-[#0f172a] p-6 md:p-8 rounded-3xl border border-gray-100 dark:border-[#1e293b] shadow-sm",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
										className: "text-lg font-bold mb-6 text-gray-900 dark:text-white flex items-center gap-2",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
											className: "w-5 h-5 text-indigo-500",
											fill: "none",
											stroke: "currentColor",
									...
									className: "bg-white dark:bg-[#0f172a] p-6 md:p-8 rounded-3xl border border-gray-100 dark:border-[#1e293b] shadow-sm flex flex-col items-center",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
											className: "text-lg font-bold mb-2 text-gray-900 dark:text-white w-full flex items-center gap-2",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ResponsiveContainer, {
												...
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PieChart, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pie, {
													...
													dataKey: "value",
													stroke: "none",
													children: statistics.rsvpPie.map((entry, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Cell, { fill: index === 0 ? "#10b981" : "#ef4444" }, `cell-${index}`))
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "flex items-center justify-center gap-6 mt-2 w-full",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "flex items-center gap-2",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-3 h-3 rounded-full bg-[#10b981]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "text-sm text-gray-600 dark:text-gray-300 font-medium",
													children: "Hadir"
												})]
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "flex items-center gap-2",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-3 h-3 rounded-full bg-[#ef4444]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "text-sm text-gray-600 dark:text-gray-300 font-medium",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "bg-white dark:bg-[#0f172a] rounded-3xl border border-gray-100 dark:border-[#1e293b] shadow-sm overflow-hidden mb-12",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "p-6 border-b border-gray-100 dark:border-[#1e293b]",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
											className: "bg-gray-50 dark:bg-[#1e293b]/50",
											children: [
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
													className: "py-4 px-6 text-xs font-bold text-gray-500 uppercase tracking-wider",
													children: "Judul / Klien"
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
													className: "py-4 px-6 text-xs font-bold text-gray-500 uppercase tracking-wider text-center",
													children: "Kunjungan"
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
													className: "py-4 px-6 text-xs font-bold text-gray-500 uppercase tracking-wider text-center",
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
													className: "py-4 px-6 text-xs font-bold text-gray-500 uppercase tracking-wider text-right",
													children: "Aksi"
												})
											]
										}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", {
											className: "divide-y divide-gray-100 dark:divide-[#1e293b]",
											children: statistics.topInvitations.map((inv) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
												className: "hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors",
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
														className: "py-3 px-6",
														children: inv.thumbnail ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
															src: inv.thumbnail,
															alt: inv.title,
															className: "w-10 h-10 rounded-lg object-cover shadow-sm"
														}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
															className: "w-10 h-10 rounded-lg overflow-hidden relative bg-gray-200 dark:bg-gray-800 shadow-sm border border-gray-100 dark:border-gray-700",
															children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
																style: {
																	width: "414px",
																	height: "414px",
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
														className: "py-3 px-6 font-bold text-gray-900 dark:text-gray-100",
														children: inv.title
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
														className: "py-3 px-6 text-center",
														children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
															className: "inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 text-sm font-bold",
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
																className: "w-4 h-4",
																fill: "none",
																stroke: "currentColor",
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
														className: "py-3 px-6 text-center",
														children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
															className: "inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-orange-50 dark:bg-orange-500/10 text-orange-600 dark:text-orange-400 text-sm font-bold",
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
																className: "w-4 h-4",
																fill: "none",
																stroke: "currentColor",
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
														className: "py-3 px-6 text-center",
														children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
															className: "inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 text-sm font-bold",
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
																className: "w-4 h-4",
																fill: "none",
																stroke: "currentColor",
					...
					activeTab === "pesanan" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "max-w-6xl mx-auto animate-fade-in-up",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "mb-8",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
									className: "text-3xl font-extrabold text-gray-900 dark:text-white mb-2",
									children: "Manajemen Pesanan"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-gray-500 dark:text-gray-400",
									children: "Kelola pesanan dari Landing Page, generate form aset, dan buat project."
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "bg-white dark:bg-[#0f172a] rounded-xl p-4 border border-gray-100 dark:border-[#1e293b] shadow-sm flex flex-col justify-center",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "bg-white dark:bg-[#0f172a] rounded-xl p-4 border border-yellow-100 dark:border-yellow-900/30 shadow-sm flex flex-col justify-center",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
											className: "text-xs font-semibold text-yellow-600 dark:text-yellow-500 uppercase tracking-wider mb-1 flex items-center gap-1.5",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "w-2 h-2 rounded-full bg-yellow-500" }), " Pending"]
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
											className: "text-2xl font-black text-gray-900 dark:text-white",
											children: orders.filter((o) => String(o.status).toLowerCase() === "pending").length
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "bg-white dark:bg-[#0f172a] rounded-xl p-4 border border-blue-100 dark:border-blue-900/30 shadow-sm flex flex-col justify-center",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
											className: "text-xs font-semibold text-blue-600 dark:text-blue-500 uppercase tracking-wider mb-1 flex items-center gap-1.5",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "w-2 h-2 rounded-full bg-blue-500" }), " Diproses"]
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
											className: "text-2xl font-black text-gray-900 dark:text-white",
											children: orders.filter((o) => String(o.status).toLowerCase() === "diproses").length
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "bg-white dark:bg-[#0f172a] rounded-xl p-4 border border-emerald-100 dark:border-emerald-900/30 shadow-sm flex flex-col justify-center",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
											className: "text-xs font-semibold text-emerald-600 dark:text-emerald-500 uppercase tracking-wider mb-1 flex items-center gap-1.5",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "w-2 h-2 rounded-full bg-emerald-500" }), " Selesai"]
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
											className: "text-2xl font-black text-gray-900 dark:text-white",
											children: orders.filter((o) => ["selesai", "completed"].includes(String(o.status).toLowerCase())).length
										})]
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "bg-white dark:bg-[#0f172a] rounded-xl p-4 border border-red-100 dark:border-red-900/30 shadow-sm flex flex-col justify-center",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
											className: "text-xs font-semibold text-red-600 dark:text-red-500 uppercase tracking-wider mb-1 flex items-center gap-1.5",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "w-2 h-2 rounded-full bg-red-500" }), " Dibatalkan"]
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
											className: "text-2xl font-black text-gray-900 dark:text-white",
											children: orders.filter((o) => String(o.status).toLowerCase() === "dibatalkan").length
										})]
									})
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: orders.map((order) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "bg-white dark:bg-[#0f172a] rounded-2xl border border-gray-100 dark:border-[#1e293b] shadow-sm overflow-hidden flex flex-col relative group",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "absolute inset-0 bg-black/0 group-hover/thumb:bg-black/20 z-10 transition-colors flex items-center justify-center",
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
													className: "w-8 h-8 text-white opacity-0 group-hover/thumb:opacity-100 transition-opacity drop-shadow-md",
													fill: "none",
													stroke: "currentColor",
													viewBox: "0 0 24 24",
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
											...
											order.template && order.template.image ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
												src: `${window.ASSET_URL || "/storage/"}${order.template.image}`,
												className: "w-full h-full object-cover opacity-80",
												alt: order.template.name
											}) : order.template && order.template.preview_url ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "w-full h-full relative bg-gray-900 pointer-events-none",
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MobilePreview, {
													slug: (() => {
														try {
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: `absolute top-3 right-3 px-2.5 py-1 backdrop-blur text-xs font-bold rounded-lg uppercase tracking-wider shadow-sm z-10 ${String(order.status).toLowerCase() === "pending" ? "bg-yellow-500/90 text-white" : String(order.status).toLowerCase() === "diproses" ? "bg-blue-500/90 text-white" : String(order.status).toLowerCase() === "revisi" ? "bg-orange-500/90 text-white" : ["selesai", "completed"].includes(String(order.status).toLowerCase()) ? "bg-emerald-500/90 text-white" : String(order.status).toLowerCase() === "dibatalkan" ? "bg-red-500/90 text-white" : "bg-gray-500/90 text-white"}`,
												children: String(order.status).toLowerCase() === "completed" ? "Selesai" : order.status
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
												className: "text-sm text-gray-500 dark:text-gray-400 mb-4 flex items-center gap-1.5",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
													className: "w-4 h-4",
													fill: "none",
													stroke: "currentColor",
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
													className: "text-xs text-gray-500 mb-1.5 block font-medium",
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
														...
														className: `w-full text-sm font-semibold rounded-xl border-gray-200 dark:border-gray-700 p-2.5 pr-8 appearance-none focus:ring-2 focus:ring-offset-1 focus:outline-none transition shadow-sm ${String(order.status).toLowerCase() === "pending" ? "bg-yellow-50 dark:bg-yellow-900/20 text-yellow-700 dark:text-yellow-400 focus:ring-yellow-500" : String(order.status).toLowerCase() === "diproses" ? "bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 focus:ring-blue-500" : String(order.status).toLowerCase() === "revisi" ? "bg-orange-50 dark:bg-orange-900/20 text-orange-700 dark:text-orange-400 focus:ring-orange-500" : ["selesai", "completed"].includes(String(order.status).toLowerCase()) ? "bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-400 focus:ring-emerald-500" : String(order.status).toLowerCase() === "dibatalkan" ? "bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-400 focus:ring-red-500" : "bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-gray-500"}`,
														children: [
														...
														children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
															className: `w-4 h-4 ${String(order.status).toLowerCase() === "pending" ? "text-yellow-500" : String(order.status).toLowerCase() === "diproses" ? "text-blue-500" : String(order.status).toLowerCase() === "revisi" ? "text-orange-500" : ["selesai", "completed"].includes(String(order.status).toLowerCase()) ? "text-emerald-500" : String(order.status).toLowerCase() === "dibatalkan" ? "text-red-500" : "text-gray-500"}`,
															fill: "none",
															stroke: "currentColor",
															viewBox: "0 0 24 24",
															children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [!order.form_token ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							orders.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "text-center py-20 bg-white dark:bg-[#0f172a] rounded-2xl border border-gray-100 dark:border-[#1e293b]",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										children: "Pesanan dari klien akan otomatis muncul di sini."
									})
								]
							}),
							selectedOrder && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									className: "bg-white dark:bg-[#0f172a] w-full max-w-2xl rounded-2xl shadow-2xl relative z-10 max-h-[90vh] flex flex-col overflow-hidden animate-fade-in-up border border-gray-200 dark:border-gray-800",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
												...
												children: ["ID Pesanan: #", selectedOrder.id]
											})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
												onClick: () => setSelectedOrder(null),
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [
														...
														/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
															...
															children: [selectedOrder.customer_phone || "-", selectedOrder.customer_phone && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
														...
														/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
															className: "text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1",
															children: "Tanggal Acara"
														}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
															className: "text-base font-medium text-gray-900 dark:text-white",
															children: selectedOrder.event_date ? new Date(selectedOrder.event_date).toLocaleDateString("id-ID", {
																weekday: "long",
																year: "numeric",
																month: "long",
																day: "numeric"
														...
														/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
															...
															children: ["Rp ", new Intl.NumberFormat("id-ID").format(selectedOrder.total_price || 0)]
														})] }),
														/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
															className: "text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1",
															children: "Template Terpilih"
														}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
															className: "text-base font-medium text-gray-900 dark:text-white",
															children: selectedOrder.template?.name || "Tidak ada/dihapus"
														})] }),
														/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
															className: "text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1",
															children: "Estimasi Tamu"
														}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
															className: "text-base font-medium text-gray-900 dark:text-white",
															children: [selectedOrder.guest_list || 0, " Orang"]
														})] })
													]
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
														className: "text-sm font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2",
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
														...
														className: "bg-gray-50 dark:bg-gray-800/50 p-4 rounded-xl border border-gray-100 dark:border-gray-800 text-sm text-gray-700 dark:text-gray-300",
														children: selectedOrder.custom_requests || /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
															className: "italic text-gray-400",
															children: "Tidak ada catatan khusus dari klien."
														})
													})]
												}),
												selectedOrder.details && Object.keys(selectedOrder.details).length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
													className: "text-sm font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2",
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
														className: "w-4 h-4 text-indigo-500",
														fill: "none",
													...
													children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("table", {
														...
														children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: Object.entries(selectedOrder.details).map(([key, value], idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
															className: idx !== Object.keys(selectedOrder.details).length - 1 ? "border-b border-gray-100 dark:border-gray-700/50" : "",
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
																className: "py-3 px-4 font-semibold text-gray-600 dark:text-gray-400 w-1/3 bg-gray-50 dark:bg-gray-800/30 capitalize",
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "p-6 border-t border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-[#0f172a] flex justify-end",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
												onClick: () => setSelectedOrder(null),
												className: "px-6 py-2.5 bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-white rounded-xl font-bold transition",
												children: "Tutup"
											})
										})
									]
					...
					activeTab === "beranda" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "w-full bg-gradient-to-r from-blue-700 via-indigo-600 to-purple-700 rounded-2xl p-6 md:p-8 mb-8 shadow-lg relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute top-0 right-0 w-64 h-64 bg-white opacity-10 rounded-full blur-3xl -translate-y-10 translate-x-10" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "relative z-10 flex-1",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
										className: "text-2xl md:text-3xl font-extrabold text-white mb-2 leading-tight",
										children: "Mulai mendesain mahakarya Anda."
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "text-blue-100 text-sm md:text-base max-w-xl opacity-90",
										children: "Buat undangan digital interaktif dan animasi memukau hanya dalam beberapa klik."
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "relative z-10 w-full md:w-96 shrink-0",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "bg-white/10 backdrop-blur-md border border-white/20 rounded-xl flex items-center px-4 py-2.5 shadow-inner hover:bg-white/15 transition-colors focus-within:bg-white/15 focus-within:border-white/40",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
											...
											type: "text",
											placeholder: "Cari template (misal: Pernikahan Elegan)",
											className: "bg-transparent border-none text-white placeholder-white/50 w-full focus:outline-none focus:ring-0 text-sm"
										})]
									})
								})
							]
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							className: "text-2xl font-bold mb-6 flex items-center gap-2 text-gray-900 dark:text-gray-100",
							children: "Mulai Baru"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 mb-12",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								onClick: isLoading ? void 0 : handleCreateBlank,
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "h-48 bg-white dark:bg-[#0f172a] flex items-center justify-center relative overflow-hidden",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-blue-500/5 group-hover:bg-blue-500/10 transition-colors" }),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute w-40 h-40 bg-blue-500/20 blur-3xl rounded-full group-hover:bg-blue-500/30 transition-colors" }),
										isLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-12 h-12 border-4 border-blue-500 border-t-transparent rounded-full animate-spin relative z-10" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "w-16 h-16 rounded-full bg-gradient-to-tr from-blue-600 to-cyan-500 flex items-center justify-center shadow-[0_0_20px_rgba(59,130,246,0.5)] group-hover:scale-110 transition-transform duration-300 relative z-10",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
									...
									className: "p-5 bg-white dark:bg-[#1e293b] relative z-10 border-t border-gray-200 dark:border-[#334155]",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
										className: "text-lg font-semibold text-gray-900 dark:text-white group-hover:text-blue-400 transition-colors",
										children: "Kanvas Kosong"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "text-sm text-gray-500 dark:text-gray-400 mt-1",
										children: "Buat desain dari awal"
									})]
								})]
							}), templates.map((template) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								onClick: isLoading ? void 0 : () => handleUseTemplate(template.id),
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "h-48 bg-gray-100 dark:bg-gray-800 flex items-center justify-center relative overflow-hidden group-hover:border-purple-500/50",
									children: [
										template.thumbnail_path ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
											src: template.thumbnail_path.startsWith("http") ? template.thumbnail_path : `/${template.thumbnail_path}`,
											alt: "Preview",
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "absolute top-3 right-3 px-2 py-1 bg-black/60 backdrop-blur rounded text-xs font-bold text-yellow-400 border border-yellow-500/30 z-20 shadow-lg",
											children: template.price > 0 ? "Rp " + Number(template.price).toLocaleString("id-ID") : "Gratis"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "absolute inset-0 bg-black/0 group-hover:bg-black/20 dark:group-hover:bg-black/40 transition-colors z-10 flex items-center justify-center opacity-0 group-hover:opacity-100",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm shadow-xl rounded-lg px-4 py-2 flex items-center gap-2 transform translate-y-4 group-hover:translate-y-0 transition-all",
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
													className: "text-gray-900 dark:text-white font-bold tracking-widest text-sm flex items-center gap-2",
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
														className: "w-5 h-5",
														fill: "none",
														stroke: "currentColor",
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "absolute -top-4 right-4 bg-white dark:bg-[#0f172a] border border-gray-200 dark:border-[#334155] text-xs font-bold text-gray-500 dark:text-gray-400 px-2 py-1 rounded-full shadow-lg flex items-center gap-1",
											children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
											className: "text-lg font-semibold text-gray-900 dark:text-white group-hover:text-purple-400 transition-colors truncate",
											children: template.title
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "text-sm text-gray-500 dark:text-gray-400 mt-1 truncate",
											children: template.category || "Uncategorized"
										})
									]
								})]
							}, template.id))]
					...
					activeTab === "tamu" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							className: "text-2xl font-bold text-gray-900 dark:text-gray-100",
							children: "Daftar Kehadiran (RSVP)"
						})
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "bg-white dark:bg-[#1e293b] border border-gray-200 dark:border-[#334155] rounded-2xl overflow-hidden shadow-lg",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
							className: "w-full text-left border-collapse",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
								className: "bg-white dark:bg-[#0f172a] border-b border-gray-200 dark:border-[#334155]",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
										className: "py-4 px-6 text-sm font-semibold text-gray-500 dark:text-gray-400",
										children: "Nama Tamu"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
										className: "py-4 px-6 text-sm font-semibold text-gray-500 dark:text-gray-400",
							...
							}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: rsvps.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								colSpan: "5",
								className: "py-8 text-center text-gray-500",
								children: "Belum ada data RSVP yang masuk."
							}) }) : rsvps.map((rsvp) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
								className: "border-b border-gray-200 dark:border-[#334155]/50 hover:bg-gray-200 dark:bg-[#334155]/20 transition-colors",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										className: "py-4 px-6 text-gray-800 dark:text-gray-200 font-medium",
										children: rsvp.name
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										className: "py-4 px-6",
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: `px-3 py-1 rounded-full text-xs font-bold ${rsvp.status === "Hadir" ? "bg-green-500/20 text-green-400" : "bg-red-500/20 text-red-400"}`,
											children: rsvp.status
										})
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
										className: "py-4 px-6 text-gray-500 dark:text-gray-400 text-sm italic",
										children: [
											"\"",
											rsvp.message || "-",
											"\""
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										className: "py-4 px-6 text-gray-500 dark:text-gray-400 text-sm truncate max-w-[150px]",
										children: rsvp.invitation?.title || "Undangan"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										className: "py-4 px-6 text-gray-500 text-sm",
										children: new Date(rsvp.created_at).toLocaleString("id-ID")
									})
								]
							}, rsvp.id)) })]
						})
					})] }),
					activeTab === "distribusi" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "flex items-center justify-between mb-6 mt-4",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
								className: "text-2xl font-bold text-gray-900 dark:text-gray-100",
								children: "Distribusi Link Undangan"
							})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "bg-white dark:bg-[#1e293b] p-6 border border-gray-200 dark:border-[#334155] rounded-2xl shadow-lg mb-6",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
									className: "text-lg font-semibold text-gray-900 dark:text-white mb-4",
									children: "Pilih Undangan & Buat Link"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
											value: "",
											children: "-- Pilih Undangan --"
										}), invitations.map((inv) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
											value: inv.id,
											children: inv.title
										}, inv.id))]
									})
								...
								selectedInvitation && (() => {
									...
									return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "mt-8 mb-6 p-6 bg-white dark:bg-[#0f172a] rounded-2xl border border-gray-200 dark:border-[#334155]",
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
													className: "text-xl font-bold text-gray-900 dark:text-white mb-6 border-b border-[#1e293b] pb-4",
													children: "1. Status Undangan & Akses Portal Klien"
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: "grid grid-cols-1 lg:grid-cols-2 gap-8",
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
														className: "block text-sm font-bold text-gray-800 dark:text-gray-200 mb-4 flex items-center gap-2",
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
															className: "w-4 h-4 text-indigo-500",
															fill: "none",
															stroke: "currentColor",
														...
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
															className: `relative flex flex-col p-4 cursor-pointer rounded-2xl border-2 transition-all duration-300 ${publishStatus === "draft" ? "border-indigo-500 bg-indigo-50 dark:bg-indigo-900/20" : "border-gray-200 dark:border-[#334155] bg-white dark:bg-[#1e293b] hover:border-indigo-200 dark:hover:border-indigo-800"}`,
															children: [
																/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
																	type: "radio",
																	name: "publish_status",
																...
																/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																	...
																	children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																		className: "flex items-center gap-2",
																		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
																			className: `p-2 rounded-lg ${publishStatus === "draft" ? "bg-indigo-100 dark:bg-indigo-800/50 text-indigo-600 dark:text-indigo-300" : "bg-gray-100 dark:bg-gray-800 text-gray-500"}`,
																			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
																				className: "w-5 h-5",
																				fill: "none",
																				stroke: "currentColor",
																			...
																			className: `font-bold ${publishStatus === "draft" ? "text-indigo-900 dark:text-indigo-100" : "text-gray-700 dark:text-gray-300"}`,
																			children: "Private Draft"
																		})]
																	}), publishStatus === "draft" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-3 h-3 rounded-full bg-indigo-500 animate-pulse" })]
																}),
																/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																	className: `text-xs mt-1 ${publishStatus === "draft" ? "text-indigo-700/70 dark:text-indigo-300/70" : "text-gray-500 dark:text-gray-400"}`,
																	children: "Undangan ditutup. Portal klien dinonaktifkan sepenuhnya."
																})
															]
														}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
															className: `relative flex flex-col p-4 cursor-pointer rounded-2xl border-2 transition-all duration-300 ${publishStatus === "published" ? "border-emerald-500 bg-emerald-50 dark:bg-emerald-900/20" : "border-gray-200 dark:border-[#334155] bg-white dark:bg-[#1e293b] hover:border-emerald-200 dark:hover:border-emerald-800"}`,
															children: [
																/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
																	type: "radio",
																	name: "publish_status",
																...
																/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																	...
																	children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																		className: "flex items-center gap-2",
																		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
																			className: `p-2 rounded-lg ${publishStatus === "published" ? "bg-emerald-100 dark:bg-emerald-800/50 text-emerald-600 dark:text-emerald-300" : "bg-gray-100 dark:bg-gray-800 text-gray-500"}`,
																			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
																				className: "w-5 h-5",
																				fill: "none",
																				stroke: "currentColor",
																			...
																			className: `font-bold ${publishStatus === "published" ? "text-emerald-900 dark:text-emerald-100" : "text-gray-700 dark:text-gray-300"}`,
																			children: "Go Public"
																		})]
																	}), publishStatus === "published" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-3 h-3 rounded-full bg-emerald-500 animate-pulse shadow-[0_0_8px_rgba(16,185,129,0.8)]" })]
																}),
																/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
																	className: `text-xs mt-1 ${publishStatus === "published" ? "text-emerald-700/70 dark:text-emerald-300/70" : "text-gray-500 dark:text-gray-400"}`,
																	children: "Undangan bisa diakses. Portal klien aktif untuk dishare."
																})
															]
														})]
													})] }), publishStatus === "published" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														...
														children: [
															...
															/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																...
																children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
																	...
																	children: [
																		...
																		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
																			value: "forever",
																			children: "Selamanya (Tidak Kedaluwarsa)"
																		})
																	]
																}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
															...
															currentInv?.expires_at && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																className: "mt-3 flex items-start gap-2 bg-orange-50 dark:bg-orange-900/10 text-orange-600 dark:text-orange-400 p-3 rounded-lg border border-orange-100 dark:border-orange-800/30",
																children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
																	...
																	children: ["Link undangan ini dijadwalkan kedaluwarsa pada: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
																		className: "font-bold",
																		children: new Date(currentInv.expires_at).toLocaleDateString("id-ID", {
																			weekday: "long",
																			year: "numeric",
																			month: "long",
																			day: "numeric"
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: "mt-8 pt-6 border-t border-gray-100 dark:border-[#1e293b] flex items-center justify-between",
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
														className: "text-xs text-gray-500 dark:text-gray-400 max-w-sm hidden md:block",
														children: "Pastikan untuk menyimpan perubahan agar status publikasi klien ter-update secara realtime."
													}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
														...
														children: isPublishing ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
														...
														}), "Menyimpan..."] }) : "Simpan Pengaturan"
													})]
												}),
												currentInv?.status === "published" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: "mt-6 p-5 bg-gradient-to-r from-emerald-500/10 to-teal-500/10 border border-emerald-500/30 rounded-2xl relative overflow-hidden group",
													children: [
														/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -right-10 -top-10 w-40 h-40 bg-emerald-500/10 rounded-full blur-2xl group-hover:bg-emerald-500/20 transition-all" }),
														/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
															className: "text-sm font-extrabold text-emerald-600 dark:text-emerald-400 mb-2 flex items-center gap-2 relative z-10",
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
																className: "w-5 h-5",
																fill: "none",
																stroke: "currentColor",
														...
														/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
															className: "text-xs text-gray-600 dark:text-gray-400 mb-4 relative z-10 leading-relaxed",
															children: [
																"Berikan link di bawah ini kepada pengantin agar mereka dapat ",
																/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "menyebar undangan WA sendiri" }),
																" tanpa perlu mengakses dasbor admin Anda."
															]
														}),
														/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
															className: "flex flex-col sm:flex-row items-stretch sm:items-center gap-3 relative z-10",
															children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
																className: "flex-1 bg-white/50 dark:bg-black/20 border border-emerald-500/20 rounded-lg px-4 py-2.5 font-mono text-sm text-emerald-700 dark:text-emerald-300 truncate",
																children: [
																...
																href: `/client/${currentInv.slug}`,
																target: "_blank",
																className: "px-6 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-bold rounded-lg shadow-lg hover:shadow-emerald-500/30 transition-all text-center whitespace-nowrap",
																children: "Buka Portal Klien"
															})]
														})
													]
												})
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
											className: "text-xl font-bold text-gray-900 dark:text-white mb-6 mt-8",
											children: "2. Pengaturan Template WA & Buat Link Tamu"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "grid grid-cols-1 md:grid-cols-2 gap-6",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "bg-white dark:bg-[#0f172a] p-4 rounded-xl border border-gray-200 dark:border-[#334155]",
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
														className: "text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3",
														children: "Buat Link Satuan"
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
														...
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
															...
															type: "submit",
															className: "px-4 py-2 bg-purple-600 hover:bg-purple-500 rounded-lg font-bold text-gray-900 dark:text-white transition-colors text-sm",
															children: "Buat"
														})]
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
														className: "text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 mt-6",
														children: "Buat Link Massal"
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
														onSubmit: handleBatchCreateLinks,
														className: "flex flex-col gap-2",
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
															...
															type: "submit",
															className: "px-4 py-2 bg-purple-600 hover:bg-purple-500 rounded-lg font-bold text-gray-900 dark:text-white transition-colors text-sm w-full",
															children: "Buat Sekaligus"
														})]
													})
												]
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														...
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
															...
															children: "Template Ucapan WA"
														}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
															onClick: handleSaveGreeting,
															className: "px-3 py-1 bg-green-600/20 text-green-400 hover:bg-green-600/30 rounded text-xs font-bold transition-colors",
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
														...
														children: [
															...
															/* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", {
																className: "text-purple-400",
																children: "[LINK_UNDANGAN]"
															}),
															" yang akan otomatis diganti saat dikirim."
														]
													}),
						...
						selectedInvitation && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "bg-white dark:bg-[#1e293b] border border-gray-200 dark:border-[#334155] rounded-2xl overflow-hidden shadow-lg",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
								className: "w-full text-left border-collapse",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", {
											className: "py-4 px-6 text-sm font-semibold text-gray-500 dark:text-gray-400 text-right",
											children: "Aksi"
										})
									]
								}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: guestLinks.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
									colSpan: "3",
									className: "py-8 text-center text-gray-500",
									children: "Belum ada link yang dibuat."
								}) }) : guestLinks.map((link) => {
									const invitation = invitations.find((i) => i.id === link.invitation_id);
									const url = `${window.location.origin}/${invitation?.slug}?to=${encodeURIComponent(link.guest_name)}`;
									return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												className: "py-4 px-6 text-gray-800 dark:text-gray-200 font-medium",
												children: link.guest_name
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												className: "py-4 px-6 text-gray-500 dark:text-gray-400 text-sm truncate max-w-[250px]",
												children: url
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
					...
					activeTab === "template" && (() => {
						...
						dbFolders.forEach((dbf) => {
							if (!templateFolders[dbf.name]) templateFolders[dbf.name] = [];
						});
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center justify-between mb-6 mt-4",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
								className: "text-2xl font-bold text-gray-900 dark:text-gray-100",
								children: "Kelola Template"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-gray-500 dark:text-gray-400 text-sm mt-1",
								children: "Manajemen template desain Anda berdasarkan kategori/folder."
							})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex gap-2",
								children: [!activeFolder && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								}), activeFolder && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						}), !activeFolder ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6",
							children: [Object.entries(templateFolders).map(([folderName, items]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "w-16 h-16 rounded-full bg-indigo-500/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform",
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
										...
										children: [items.length, " Template"]
									})
								]
							}, folderName)), Object.keys(templateFolders).length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "col-span-full py-12 text-center border-2 border-dashed border-gray-200 dark:border-[#334155] rounded-2xl",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-gray-500 dark:text-gray-400 mb-4",
									children: "Belum ada folder atau template."
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									onClick: handleCreateFolder,
									className: "px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg text-sm font-semibold transition-colors",
									children: "Buat Folder Pertama"
								})]
							})]
						}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-3 mb-6 pb-4 border-b border-gray-200 dark:border-[#334155]",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
									...
									children: ["Folder: ", activeFolder]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									className: "px-2.5 py-0.5 rounded-full bg-gray-200 dark:bg-[#334155] text-xs font-semibold text-gray-700 dark:text-gray-300 ml-2",
									children: [templateFolders[activeFolder]?.length || 0, " Item"]
								})
							]
						}), templateFolders[activeFolder]?.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "py-12 text-center border-2 border-dashed border-gray-200 dark:border-[#334155] rounded-2xl",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-gray-500 dark:text-gray-400",
								children: "Folder ini masih kosong."
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "text-xs text-gray-500 mt-2",
								children: [
									"Buka proyek Anda di Builder dan klik \"Simpan sbg Template\" ke folder \"",
									activeFolder,
									"\"."
								]
							})]
							...
							children: templateFolders[activeFolder]?.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "bg-white dark:bg-[#1e293b] border border-gray-200 dark:border-[#334155] rounded-2xl overflow-hidden hover:border-[#475569] transition-all shadow-lg flex flex-col relative group",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "absolute top-2 right-2 z-10 opacity-0 group-hover:opacity-100 transition-opacity",
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
											className: "cursor-pointer bg-black/60 hover:bg-black/80 backdrop-blur text-gray-900 dark:text-white p-2 rounded-lg flex items-center justify-center transition",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "h-48 w-full bg-white dark:bg-[#0f172a] relative border-b border-gray-200 dark:border-[#334155]",
										children: item.thumbnail_path ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
												className: "font-bold text-lg text-gray-900 dark:text-gray-100 mb-1 line-clamp-1",
												children: item.title
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "flex items-center gap-2 mb-3",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "text-indigo-400 font-bold text-sm bg-indigo-500/10 px-2.5 py-0.5 rounded border border-indigo-500/20",
													children: item.price > 0 ? `Rp ${new Intl.NumberFormat("id-ID").format(item.price)}` : "Gratis"
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
...
var ErrorBoundary = class extends import_react.Component {
	...
	render() {
		if (this.state.hasError) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "React Crashed!" }),
...
var rootElement = document.getElementById("portal-root");
if (rootElement) try {
	rootElement.innerHTML = "<h1 style=\"color:white; padding:20px;\">Memuat React...</h1>";
	(0, import_client.createRoot)(rootElement).render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ErrorBoundary, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PortalApp, {}) }));
} catch (e) {
...
else document.body.innerHTML += "<div style=\"background:red; color:white; padding:20px; z-index:9999; position:absolute; top:0;\">CRITICAL: portal-root element not found!</div>";
//#endregion
