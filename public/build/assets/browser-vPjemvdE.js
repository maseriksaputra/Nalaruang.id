const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Container-CAsMQnXF.js","assets/ViewerApp-9HC94V_u.js","assets/bootstrap-B7MMry3r.js","assets/LogUtils-CjrGbVDZ.js","assets/jsx-runtime-B3AVLYIu.js","assets/ViewerApp-DQ4XEBu1.css"])))=>i.map(i=>d[i]);
...
var Engine = class {
	...
	async load(params) {
		...
		const { Container } = await __vitePreload(async () => {
			const { Container } = await import("./Container-CAsMQnXF.js");
			return { Container };
