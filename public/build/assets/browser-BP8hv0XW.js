const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Container-SA7ekmSt.js","assets/ViewerApp-CnhEsUjP.js","assets/bootstrap-Pg3-MOZN.js","assets/LogUtils-CjrGbVDZ.js","assets/jsx-runtime-CXf6Pf6r.js","assets/ViewerApp-DQ4XEBu1.css"])))=>i.map(i=>d[i]);
...
var Engine = class {
	...
	async load(params) {
		...
		const { Container } = await __vitePreload(async () => {
			const { Container } = await import("./Container-SA7ekmSt.js");
			return { Container };
