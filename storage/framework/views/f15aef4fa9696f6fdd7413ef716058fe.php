...
<!-- Etalase Template Section -->
    <section id="etalase" class="pt-32 pb-24 lg:pt-36 bg-sand" x-data="{
        sortBy: 'murah',
        packageFilter: 'all',
        activeCategory: '<?php echo e($service->categories->first()->id ?? 'all'); ?>',
        get templates() {
            let categoriesData = <?php echo e(Js::from($service->categories ?? [])); ?>;
            let directTemplates = <?php echo e(Js::from($service->templates ?? [])); ?>;
            let data = [];
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-end mb-8" data-aos="fade-up">
                <div>
                    <p class="text-brand-600 text-sm font-semibold tracking-widest mb-3 uppercase">Katalog <?php echo e($service->title); ?></p>
                ...
                <div class="mt-6 md:mt-0 flex flex-wrap gap-4">
                    ...
                    <select x-model="packageFilter" id="packageFilter" class="bg-white border border-gray-200 text-gray-700 py-2.5 px-4 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 cursor-pointer">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $service->packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pkg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($service->categories->count() > 0): ?>
            <!-- Tabs Kategori -->
            <div class="flex flex-wrap gap-2 mb-10 border-b border-gray-200 pb-4" data-aos="fade-up">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $service->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button @click="activeCategory = '<?php echo e($category->id); ?>'" 
                        :class="{'bg-brand-600 text-white shadow-md': activeCategory == '<?php echo e($category->id); ?>', 'bg-white text-gray-600 hover:bg-gray-50': activeCategory != '<?php echo e($category->id); ?>'}"
                        ...
                        <div class="relative bg-gray-100 overflow-hidden"
                            ...
                            <div class="absolute inset-0 bg-brand-900/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 hidden md:flex flex-col justify-center items-center gap-3 z-10 pointer-events-none">
                                <div class="pointer-events-auto flex flex-col gap-3">
                                    <template x-if="'<?php echo e($service->slug); ?>' === 'event-digital'">
...
<!-- Packages / Pricing Section -->
    <section id="packages" class="py-24 bg-sand relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($service->packages->count() > 0): ?>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch justify-center">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $service->packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="pricing-card bg-white rounded-2xl border <?php echo e($package->is_popular ? 'border-brand-500 shadow-2xl scale-105 z-10' : 'border-gray-100 shadow-lg'); ?> overflow-hidden flex flex-col relative transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl" data-aos="fade-up" data-aos-delay="<?php echo e($loop->iteration * 100); ?>">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($package->is_popular): ?>
                        ...
                        <div class="p-8 pb-6 border-b border-gray-50 text-center">
                            <h3 class="text-2xl font-serif text-brand-900 mb-4"><?php echo e($package->name); ?></h3>
                            <div class="flex items-baseline justify-center gap-1 mb-2">
                                <span class="text-sm text-gray-500 font-medium">Rp</span>
                                <span class="text-4xl font-bold text-brand-600"><?php echo e($package->price); ?></span>
                            </div>
                            ...
                            <p class="text-sm text-gray-500 mt-4"><?php echo e($package->description); ?></p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>

                        <div class="p-8 pt-6 flex-grow flex flex-col">
                            <ul class="space-y-4 mb-8 flex-grow text-sm text-gray-600">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array($package->features)): ?>
                            ...
                            <button onclick="document.getElementById('packageFilter').value = '<?php echo e($package->id); ?>'; document.getElementById('packageFilter').dispatchEvent(new Event('change')); document.getElementById('etalase').scrollIntoView({behavior: 'smooth'})" class="block w-full py-3.5 px-4 text-center rounded-xl text-sm font-semibold transition-colors duration-300 <?php echo e($package->is_popular ? 'bg-brand-600 text-white hover:bg-brand-700 shadow-md' : 'bg-brand-50 text-brand-600 hover:bg-brand-100'); ?>">
                                Pilih Paket Ini
                            </button>
                        </div>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16" data-aos="fade-up">
                ...
                <p class="text-gray-500">
                    <?php echo e($service->slug == 'event-digital' 
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-8 text-center relative">
                ...
                <div class="relative z-10" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <h4 class="font-medium text-brand-900 text-sm">
                        <?php echo e($service->slug == 'event-digital' ? 'Pilih Desain Tema' : 'Pilih Desain / Produk'); ?>
                ...
                <div class="relative z-10" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <h4 class="font-medium text-brand-900 text-sm">
                        <?php echo e($service->slug == 'event-digital' ? 'Pilih Paket Harga' : 'Tentukan Spesifikasi Cetak'); ?>
                ...
                <div class="relative z-10" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <h4 class="font-medium text-brand-900 text-sm">
                        <?php echo e($service->slug == 'event-digital' ? 'Lengkapi Data & Daftar Tamu' : 'Kirim File / Detail Request'); ?>
                ...
                <div class="relative z-10" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <h4 class="font-medium text-brand-900 text-sm">
                        <?php echo e($service->slug == 'event-digital' ? 'Tim Kami Memproses Pembuatan' : 'Proses Produksi / Cetak'); ?>
                ...
                <div class="relative z-10 col-span-2 md:col-span-1" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <h4 class="font-medium text-brand-900 text-sm">
                        <?php echo e($service->slug == 'event-digital' ? 'Undangan Siap Dibagikan' : 'Pesanan Siap Dikirim'); ?>
...
<!-- Custom Request Banner -->
    <section class="py-20 bg-brand-900 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 text-center relative z-10">
            ...
            <a href="https://wa.me/6285196811112?text=Halo,%20saya%20ingin%20konsultasi%20layanan%20kustom%20untuk%20<?php echo e(urlencode($service->title)); ?>" target="_blank" class="inline-block bg-white text-brand-900 px-8 py-3.5 rounded-full text-sm font-bold shadow-xl hover:scale-105 transform transition duration-300">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\Undangan\resources\views\service-show.blade.php ENDPATH**/ ?>