...
<body class="font-sans text-gray-800 overflow-x-hidden selection:bg-brand-500 selection:text-white">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20 items-center">
                <div class="flex-shrink-0 flex items-center">
                    <a href="<?php echo e(url('/')); ?>" class="flex items-center gap-2 group cursor-pointer" id="logo-container">
                ...
                <div class="hidden lg:flex space-x-8 text-sm font-medium">
                    <a href="<?php echo e(request()->is('/') ? '#beranda' : url('/#beranda')); ?>" class="text-white hover:text-brand-500 transition duration-300 nav-link">HOME</a>
                    <a href="<?php echo e(request()->is('/') ? '#katalog' : url('/#katalog')); ?>" class="text-white hover:text-brand-500 transition duration-300 nav-link">LAYANAN</a>
                    <a href="<?php echo e(request()->is('/') ? '#portofolio' : url('/#portofolio')); ?>" class="text-white hover:text-brand-500 transition duration-300 nav-link">PORTOFOLIO</a>
                    <a href="<?php echo e(request()->is('/') ? '#review' : url('/#review')); ?>" class="text-white hover:text-brand-500 transition duration-300 nav-link">CERITA KLIEN</a>
                </div>
                <div class="hidden md:block">
                    <a href="<?php echo e(request()->is('/') ? '#kontak' : url('/#kontak')); ?>" id="nav-btn" class="bg-white/20 hover:bg-white hover:text-brand-900 backdrop-blur-sm text-white px-6 py-2.5 rounded-full text-sm font-medium transition duration-300 flex items-center gap-2 transform">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li><a href="<?php echo e(request()->is('/') ? '#katalog' : url('/#katalog')); ?>" class="hover:text-white transition flex items-center gap-2"><span class="w-1.5 h-1.5 rounded-full bg-brand-500"></span> Katalog Cetak & Souvenir</a></li>
                    <li><a href="<?php echo e(request()->is('/') ? '#katalog' : url('/#katalog')); ?>" class="hover:text-white transition flex items-center gap-2"><span class="w-1.5 h-1.5 rounded-full bg-brand-500"></span> Undangan Website</a></li>
                    <li><a href="<?php echo e(request()->is('/') ? '#katalog' : url('/#katalog')); ?>" class="hover:text-white transition flex items-center gap-2"><span class="w-1.5 h-1.5 rounded-full bg-brand-500"></span> Jasa Web & App Design</a></li>
                </ul>
            </div>
            <div>
    ...
    <script>
        ...
        window.addEventListener('scroll', function() {
            ...
            if (window.scrollY > 50 || !<?php echo e(request()->is('/') ? 'true' : 'false'); ?>) {
...
</html><?php /**PATH D:\laragon\www\Undangan\resources\views/layouts/main.blade.php ENDPATH**/ ?>