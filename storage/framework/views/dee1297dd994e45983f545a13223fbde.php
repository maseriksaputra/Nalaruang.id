...
<div class="flex flex-col h-full font-sans" style="min-height: 100%;">
    ...
    <div class="relative w-full bg-gray-100 overflow-hidden mb-3" style="border-radius: 0.75rem; aspect-ratio: 4/3;">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->image): ?>
            <img src="<?php echo e(rtrim(str_replace('test.txt', '', Storage::url('test.txt')), '/') . '/' . $record->image); ?>" alt="<?php echo e($record->name); ?>" class="w-full h-full object-cover" style="width: 100%; height: 100%; object-fit: cover;">
        <?php elseif($iframeUrl): ?>
            ...
            <div style="width: 414px; height: 896px; transform: scale(0.65); transform-origin: top left; pointer-events: none;">
                <iframe src="<?php echo e($iframeUrl); ?>" style="width: 100%; height: 100%; border: none;" tabindex="-1" loading="lazy"></iframe>
            </div>
        <?php else: ?>
            <img src="https://placehold.co/600x800/eef2f0/2A4035?text=No+Img" alt="<?php echo e($record->name); ?>" class="w-full h-full object-cover" style="width: 100%; height: 100%; object-fit: cover;">
    ...
    <div class="flex flex-col flex-grow" style="display: flex; flex-direction: column; flex-grow: 1;">
        ...
        <div class="mb-2" style="margin-bottom: 0.5rem; display: flex;">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->serviceCategory): ?>
                <span style="background-color: #eff6ff; color: #2563eb; font-size: 10px; font-weight: bold; padding: 2px 8px; border-radius: 4px;">
                    <?php echo e($record->serviceCategory->name); ?>

                </span>
            <?php elseif($record->category): ?>
                <span style="background-color: #eff6ff; color: #2563eb; font-size: 10px; font-weight: bold; padding: 2px 8px; border-radius: 4px;">
        ...
        <div class="mb-4" style="margin-bottom: 1rem;">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->discount_price): ?>
                <span style="font-size: 12px; color: #9ca3af; text-decoration: line-through; margin-right: 4px;">Rp <?php echo e(number_format($record->price, 0, ',', '.')); ?></span>
                <span style="font-size: 15px; font-weight: 800; color: #d81b60;">Rp <?php echo e(number_format($record->discount_price, 0, ',', '.')); ?></span>
            <?php else: ?>
                <span style="font-size: 15px; font-weight: 800; color: #d81b60;">Rp <?php echo e(number_format($record->price, 0, ',', '.')); ?></span>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        ...
        <div style="margin-top: auto; border-top: 1px solid #f3f4f6; padding-top: 0.75rem;">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.5rem; position: relative;">
                ...
                <div style="display: flex; flex-direction: column;">
                    <span style="font-weight: 700; color: #111827; font-size: 14px; line-height: 1;"><?php echo e($record->orders_count ?? 0); ?></span>
                ...
                <div style="display: flex; flex-direction: column; padding-left: 1rem;">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($record->stok ?? 0) > 0): ?>
...
<?php /**PATH D:\laragon\www\Undangan\resources\views\filament\tables\columns\template-card.blade.php ENDPATH**/ ?>