            ...
            <div class="flex justify-between h-20 items-center">
                <div class="flex-shrink-0 flex items-center">
                    <div class="flex items-center gap-2 group cursor-pointer" id="logo-container">
                        <img src="<?php echo e(asset('logo.png')); ?>" alt="Nalaruang.id" class="h-20 w-auto object-contain transform scale-150 origin-left transition duration-300" id="logo-img">
                    </div>
                </div>
                ...
                <div class="mb-16 last:mb-0" data-aos="fade-up">
                    ...
                    <div x-data="{ 
                        ...
                        <div x-ref="slider" @scroll.passive="checkScroll" class="flex overflow-x-auto hide-scrollbar gap-4 md:gap-5 snap-x snap-mandatory pb-4 -mx-4 px-4 sm:mx-0 sm:px-0 relative scroll-smooth">
                            ...
                            ?>
                            <div x-data="{ currentSlide: 0, slides: <?php echo e(json_encode($allImages)); ?> }" 
                                 ...
                                 data-aos="zoom-in" data-aos-delay="<?php echo e($loop->iteration * 50); ?>">
                                 
                                <div class="relative w-full bg-sand group-hover:opacity-95 transition-opacity"
                                     style="aspect-ratio: <?php echo e($template->image_aspect_ratio && $template->image_aspect_ratio !== 'auto' ? (str_contains($template->image_aspect_ratio, '/') ? $template->image_aspect_ratio : '1/1') : '1/1'); ?>;">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(empty($validImages) && $iframeUrl): ?>
                                        ...
                                        <div class="absolute inset-0 w-full h-full bg-gray-100 overflow-hidden pointer-events-none">
                                            <div style="width: 414px; height: 896px; transform: scale(0.58); transform-origin: top left;">
                                                <iframe src="<?php echo e($iframeUrl); ?>" class="w-full h-full border-0" tabindex="-1" loading="lazy"></iframe>
                                            </div>
                                        </div>
                                    <?php else: ?>
                                    ...
                                    <div class="absolute inset-0 bg-brand-900/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-center items-center gap-3 z-10 pointer-events-none">
                                        <div class="pointer-events-auto flex flex-col gap-2 w-full px-6">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($template->service) && $template->service->slug == 'event-digital'): ?>
                                            <a href="<?php echo e($template->preview_url ?? '#'); ?>" 
                                               <?php if(empty($template->preview_url)): ?> onclick="event.preventDefault(); alert('Demo belum tersedia untuk produk ini.');" <?php else: ?> target="_blank" <?php endif; ?>
                                            ...
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <a href="<?php echo e(route('order.create', ['template_id' => $template->id])); ?>" class="w-full py-2 bg-brand-500 hover:bg-brand-400 text-white rounded-full text-xs font-bold transition shadow-lg text-center">
                                                Detail Produk
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="p-4 flex flex-col flex-grow">
                                    <div class="flex justify-between items-start gap-2">
                                        <div class="flex-1">
                                            <a href="<?php echo e(isset($template->service) ? route('service.show', $template->service->slug) : '#'); ?>" class="text-brand-600 hover:text-brand-800 text-[10px] font-bold tracking-wider uppercase mb-1 block transition"><?php echo e($template->category ?? 'Produk Premium'); ?></a>
                                            <h3 class="text-base font-serif text-brand-900 group-hover:text-brand-700 transition-colors leading-tight line-clamp-2"><?php echo e($template->name); ?></h3>
                                        </div>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($template->discount_price && $template->discount_price < $template->price): ?>
                                                <div class="flex items-center gap-1.5 mb-0.5">
                                                    <span class="bg-red-50 text-red-600 font-bold text-[9px] px-1 py-0.5 rounded leading-none">
                                                        -<?php echo e(round((($template->price - $template->discount_price) / $template->price) * 100)); ?>%
                                                    </span>
                                                    <span class="text-[9px] text-gray-400 line-through">Rp <?php echo e(number_format($template->price, 0, ',', '.')); ?></span>
                                                </div>
                                                <span class="text-brand-800 font-bold text-sm leading-tight">Rp <?php echo e(number_format($template->discount_price, 0, ',', '.')); ?></span>
                                            <?php else: ?>
                                                <span class="text-brand-800 font-bold text-sm leading-tight mt-1">Rp <?php echo e(number_format($template->price, 0, ',', '.')); ?></span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                ...
                <div class="portfolio-item rounded-xl relative group block overflow-hidden" 
                     ...
                     data-aos="zoom-in" data-aos-delay="<?php echo e($loop->iteration * 100); ?>">
                    
                    <img src="<?php echo e($portfolio->image ? Storage::url($portfolio->image) : 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=1000'); ?>" 
                         class="portfolio-img absolute inset-0 w-full h-full object-cover" 
                    ...
                    <div class="portfolio-overlay absolute inset-0 flex flex-col justify-end p-6 pointer-events-none">
                        <div class="portfolio-text pointer-events-auto">
                            <span class="text-brand-100 hover:text-white text-xs font-bold tracking-wider uppercase mb-1 block transition"><?php echo e($portfolio->category ?? 'Karya'); ?></span>
                            <h3 class="text-lg font-serif text-white"><?php echo e($portfolio->title); ?></h3>
                        </div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-12">
            <div class="md:col-span-2">
                <div class="flex items-center gap-2 mb-6">
                    <img src="<?php echo e(asset('logo.png')); ?>" alt="Nalaruang.id" class="h-28 w-auto object-contain transform scale-125 origin-left">
                </div>
...
<?php /**PATH D:\laragon\www\Undangan\resources\views/landing.blade.php ENDPATH**/ ?>