                ...
                <div class="mb-16 last:mb-0" data-aos="fade-up">
                    ...
                    <div x-data="{ 
                        ...
                        <div x-ref="slider" @scroll.passive="checkScroll" class="flex overflow-x-auto hide-scrollbar gap-4 md:gap-5 snap-x snap-mandatory pb-4 -mx-4 px-4 sm:mx-0 sm:px-0 relative scroll-smooth">
                            ...
                            ?>
                            <div x-data="{ currentSlide: 0, slides: <?php echo e(json_encode($allImages)); ?>, init() { if (this.slides.length > 1) { setInterval(() => { this.currentSlide = this.currentSlide === this.slides.length - 1 ? 0 : this.currentSlide + 1 }, 4000) } } }" 
                                ...
                                <div class="relative w-full bg-sand group-hover:opacity-95 transition-opacity"
                                     style="aspect-ratio: <?php echo e($template->image_aspect_ratio && $template->image_aspect_ratio !== 'auto' ? (str_contains($template->image_aspect_ratio, '/') ? $template->image_aspect_ratio : '3/4') : '3/4'); ?>;">
                                ...
                                <div class="p-4 md:p-6 flex flex-col flex-grow">
                                    <div class="flex flex-col md:flex-row justify-between items-start mb-2 gap-1 md:gap-2">
                                        <h3 class="text-base md:text-xl font-serif text-brand-900 group-hover:text-brand-600 transition line-clamp-2 md:line-clamp-1 leading-snug"><?php echo e($template->name); ?></h3>
                                        <span class="bg-brand-50 text-brand-600 text-[9px] md:text-[10px] font-bold uppercase px-2 py-1 rounded whitespace-nowrap self-start mt-1 md:mt-0"><?php echo e($template->category ?? 'Produk Premium'); ?></span>
                                    </div>
                                    <div class="mt-auto pt-3 flex flex-col">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($template->discount_price && $template->discount_price < $template->price): ?>
                                            <div class="text-gray-400 text-[11px] md:text-xs line-through mb-0.5">
                                                Rp <?php echo e(number_format($template->price, 0, ',', '.')); ?>

                                            </div>
                                            <div class="text-brand-600 font-bold text-base md:text-lg">
                                                Rp <?php echo e(number_format($template->discount_price, 0, ',', '.')); ?>
