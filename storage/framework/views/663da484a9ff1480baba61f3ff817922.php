        ...
        <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
            ...
            <div class="bg-brand-900 px-6 py-10 md:px-10 md:py-12 text-center relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-brand-100 text-sm md:text-base leading-relaxed">Halo <strong><?php echo e($order->customer_name); ?></strong>, silakan lengkapi data dan aset di bawah ini untuk memproses pesanan <strong><?php echo e($template->name); ?></strong> Anda.</p>
                </div>
            </div>
            ...
            <div class="p-6 sm:p-8 md:p-10">
                ...
                <?php else: ?>
                    <form action="<?php echo e(route('client.form.submit', $order->form_token)); ?>" method="POST" enctype="multipart/form-data" class="space-y-8">
                        <?php echo csrf_field(); ?>
                        
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $schema; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-800 mb-2">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isRequired): ?> <span class="text-red-500">*</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </label>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($field['type'] === 'text'): ?>
                                    <input type="text" name="<?php echo e($fieldName); ?>" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm shadow-sm placeholder-gray-400 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 transition-all duration-200" <?php echo e($isRequired ? 'required' : ''); ?> value="<?php echo e(old($fieldName)); ?>" placeholder="Masukkan <?php echo e(strtolower($field['field_name'])); ?>...">
                                
                                <?php elseif($field['type'] === 'audio'): ?>
                                    <div class="mt-1">
                                        <input type="file" name="<?php echo e($fieldName); ?>" accept="audio/mpeg, audio/wav, audio/*" class="w-full text-sm text-gray-500 file:mr-4 file:py-2.5 file:px-5 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-brand-50 file:text-brand-700 hover:file:bg-brand-100 transition-colors cursor-pointer" <?php echo e($isRequired ? 'required' : ''); ?>>
                                        <p class="mt-2 text-xs text-gray-500">Unggah file audio format MP3 atau WAV.</p>
                                    </div>
                                
                                <?php elseif($field['type'] === 'textarea'): ?>
                                    <textarea name="<?php echo e($fieldName); ?>" rows="4" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm shadow-sm placeholder-gray-400 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 transition-all duration-200" <?php echo e($isRequired ? 'required' : ''); ?> placeholder="Tuliskan <?php echo e(strtolower($field['field_name'])); ?> di sini..."><?php echo e(old($fieldName)); ?></textarea>
                                            ...
                                            <div class="space-y-2 text-center">
                                                ...
                                                <div class="flex text-sm text-gray-600 justify-center">
                                                    <div class="relative font-semibold text-brand-600 hover:text-brand-500">
                                                        ...
                                                        <input x-ref="fileInput" @change="handleFiles($event)" name="<?php echo e($fieldName); ?>[]" type="file" class="sr-only" accept="image/*,video/mp4,video/quicktime" <?php echo e($isRequired ? 'required' : ''); ?> <?php echo e(($field['max_files'] ?? 1) > 1 || ($field['max_files'] ?? 0) === 0 ? 'multiple' : ''); ?>>
                                                    </div>
                                                </div>
                                                <p class="text-xs text-gray-500">
                                                    Format: PNG, JPG, GIF, MP4. 
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($field['max_files']) && $field['max_files'] > 0): ?>
                                                        (Maksimal <?php echo e($field['max_files']); ?> file)
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </p>
                                            </div>
                                        </label>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\Undangan\resources\views/client-form/show.blade.php ENDPATH**/ ?>