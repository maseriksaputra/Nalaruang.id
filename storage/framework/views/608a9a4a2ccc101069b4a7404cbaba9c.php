    ...
    <section id="beranda" class="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden bg-brand-900">
        ...
        <div class="absolute inset-0 w-full h-full z-0 overflow-hidden">
            <div id="hero-slider-track" class="flex h-full w-full">
                ...
                <img src="<?php echo e(Storage::url($slide->image)); ?>" alt="<?php echo e($slide->title); ?>" class="flex-none w-full h-full object-cover object-center vintage-film bg-brand-800">
    ...
    <section id="katalog" class="py-24 bg-white relative">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="service-card bg-sand hover:bg-brand-900 p-8 rounded-xl border border-gray-100 group flex flex-col relative overflow-hidden cursor-pointer" data-aos="fade-up" data-aos-delay="<?php echo e($loop->iteration * 100); ?>">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($service->is_popular): ?>
                    ...
                    <div class="w-14 h-14 bg-brand-100 group-hover:bg-brand-800 rounded-full flex items-center justify-center mb-6 text-brand-800 group-hover:text-white transition-colors duration-500 transform group-hover:scale-110">
                        <?php echo $service->icon ?? '<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"></path></svg>'; ?>

                    </div>
                    <h3 class="text-xl font-serif text-brand-900 group-hover:text-white transition-colors duration-500 mb-4"><?php echo e($service->title); ?></h3>
                    <ul class="text-gray-600 group-hover:text-brand-100 transition-colors duration-500 text-sm mb-8 space-y-3 flex-grow">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array($service->features)): ?>
                            ...
                            <li class="flex items-start"><span class="text-brand-500 group-hover:text-brand-400 transition-colors duration-500 mr-2">✦</span> <?php echo e($feature); ?></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </ul>
                    <a href="<?php echo e($service->slug ? route('service.show', $service->slug) : '#'); ?>" class="inline-flex items-center text-brand-800 group-hover:text-white text-sm font-semibold transition-colors duration-500">
    ...
    <section id="produk-katalog" class="pt-10 pb-24 bg-brand-100 relative border-t border-brand-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($service->templates->count() > 0): ?>
                <div class="mb-16 last:mb-0" data-aos="fade-up">
                    <div class="flex flex-col md:flex-row justify-between items-end mb-6">
                        <div>
                            <h3 class="text-2xl font-serif text-brand-900 mb-1"><?php echo e($service->title); ?></h3>
                            <p class="text-sm text-brand-600"><?php echo e($service->templates->count()); ?> Produk Tersedia</p>
                        </div>
                        <a href="<?php echo e($service->slug ? route('service.show', $service->slug) : '#'); ?>" class="mt-4 md:mt-0 text-brand-600 hover:text-brand-800 text-sm font-semibold inline-flex items-center group transition-colors">
                            Lihat Selengkapnya 
                    ...
                    <div class="flex overflow-x-auto hide-scrollbar gap-6 snap-x snap-mandatory pb-4 -mx-4 px-4 sm:mx-0 sm:px-0 relative">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $service->templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="snap-start shrink-0 w-[280px] sm:w-[320px] bg-sand rounded-xl border border-gray-100 overflow-hidden group hover:shadow-xl transition-all duration-500 flex flex-col relative hover:-translate-y-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($template->stok <= 0): ?>
                            ...
                            <?php elseif($template->stok < 10): ?>
                                <div class="absolute top-3 right-3 bg-amber-500 text-white text-[10px] uppercase font-bold px-3 py-1 rounded-full z-10 shadow-md tracking-wider">Sisa <?php echo e($template->stok); ?></div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="relative w-full aspect-[4/3] bg-gray-200 overflow-hidden">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($template->image): ?>
                                    <img src="<?php echo e(Storage::url($template->image)); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" alt="<?php echo e($template->name); ?>">
                                <?php else: ?>
                                ...
                                <div class="absolute inset-0 bg-brand-900/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center backdrop-blur-[2px]">
                                    <a href="<?php echo e($service->slug ? route('service.show', $service->slug) : '#'); ?>" class="bg-white/20 hover:bg-brand-600 text-white text-sm font-medium px-6 py-2.5 rounded-full border border-white/50 transition-all duration-300 transform scale-90 group-hover:scale-100">
                                        Lihat Detail
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="p-6 flex flex-col flex-grow relative">
                                ...
                                <span class="text-[10px] font-bold tracking-wider text-brand-600 uppercase mb-2"><?php echo e($template->category ?? $service->title); ?></span>
                                <h4 class="font-serif text-brand-900 text-xl mb-2 line-clamp-1 group-hover:text-brand-600 transition-colors"><?php echo e($template->name); ?></h4>
                                
                                <div class="mt-auto pt-5 flex items-center justify-between border-t border-gray-100">
                                    <div class="flex flex-col">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($template->discount_price && $template->discount_price < $template->price): ?>
                                            <span class="text-xs text-gray-400 line-through mb-0.5">Rp <?php echo e(number_format($template->price, 0, ',', '.')); ?></span>
                                            <span class="text-brand-600 font-bold text-lg">Rp <?php echo e(number_format($template->discount_price, 0, ',', '.')); ?></span>
                                        <?php else: ?>
                                            <span class="text-brand-600 font-bold text-lg">Rp <?php echo e(number_format($template->price, 0, ',', '.')); ?></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                    <a href="<?php echo e(route('order.create', $template->id)); ?>" class="w-10 h-10 rounded-full bg-brand-50 text-brand-600 hover:bg-brand-600 hover:text-white hover:shadow-lg hover:shadow-brand-600/30 flex items-center justify-center transition-all duration-300">
    ...
    <section id="portofolio" class="py-24 bg-sand">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $portfolios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $portfolio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="portfolio-item rounded-xl relative aspect-square <?php echo e($loop->iteration % 4 == 1 || $loop->iteration % 4 == 0 ? 'md:col-span-2' : ''); ?> group" data-aos="zoom-in" data-aos-delay="<?php echo e($loop->iteration * 100); ?>">
                    <img src="<?php echo e(Storage::url($portfolio->image)); ?>" class="portfolio-img w-full h-full object-cover <?php echo e($loop->iteration % 2 == 0 ? 'vintage-film' : ''); ?>" alt="<?php echo e($portfolio->title); ?>">
                    <div class="portfolio-overlay absolute inset-0 flex flex-col justify-end p-8">
                        <div class="portfolio-text">
                            <span class="text-brand-100 text-xs font-bold tracking-wider uppercase mb-2 block"><?php echo e($portfolio->category); ?></span>
                            <h3 class="text-2xl font-serif text-white"><?php echo e($portfolio->title); ?></h3>
                        </div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <section id="review" class="py-24 bg-white relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="<?php echo e($loop->iteration % 2 == 0 ? 'bg-sand p-8 rounded-2xl border border-gray-100 relative group hover:shadow-xl transition duration-300 transform md:-translate-y-4' : ($loop->iteration % 3 == 0 ? 'bg-brand-900 p-8 rounded-2xl border border-brand-800 relative group hover:shadow-2xl transition duration-300' : 'bg-sand p-8 rounded-2xl border border-gray-100 relative group hover:shadow-xl transition duration-300')); ?>" data-aos="fade-up" data-aos-delay="<?php echo e($loop->iteration * 100); ?>">
                    <div class="<?php echo e($loop->iteration % 3 == 0 ? 'text-brand-600' : 'text-brand-300'); ?> mb-4">
                    ...
                    <p class="<?php echo e($loop->iteration % 3 == 0 ? 'text-gray-300' : 'text-gray-600'); ?> mb-6 italic text-sm leading-relaxed">"<?php echo e($testimonial->content); ?>"</p>
                    <div class="flex items-center gap-4">
                        <div class="w-12 h-12 <?php echo e($loop->iteration % 3 == 0 ? 'bg-brand-800' : 'bg-gray-200'); ?> rounded-full overflow-hidden">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($testimonial->avatar): ?>
                                <img src="<?php echo e(Storage::url($testimonial->avatar)); ?>" alt="<?php echo e($testimonial->client_name); ?>" class="w-full h-full object-cover">
                            <?php else: ?>
                                <div class="w-full h-full flex items-center justify-center font-bold text-gray-500"><?php echo e(substr($testimonial->client_name, 0, 1)); ?></div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        <div>
                            <h4 class="font-serif <?php echo e($loop->iteration % 3 == 0 ? 'text-white' : 'text-brand-900'); ?> font-semibold"><?php echo e($testimonial->client_name); ?></h4>
                            <span class="text-xs <?php echo e($loop->iteration % 3 == 0 ? 'text-brand-400' : 'text-gray-500'); ?> uppercase tracking-wider"><?php echo e($testimonial->role); ?></span>
                        </div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\Undangan\resources\views\home.blade.php ENDPATH**/ ?>