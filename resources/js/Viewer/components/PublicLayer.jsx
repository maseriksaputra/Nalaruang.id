...
import { PaymentLogo, ChipIcon } from '../../Builder/utils/PaymentLogos';
                ...
                <div ref={elementRef} className="w-full h-full relative">
                    <div
                        ...
                        {layer.type === 'interactive_map' && (() => {
                            ...
                            return (
                                <div className="w-full h-full flex items-center justify-center relative overflow-hidden" style={{ opacity: mapOpacity, background: (isButtonOnly || isTextOnly) ? 'transparent' : '#e5e7eb', borderRadius: '0.75rem', border: (isButtonOnly || isTextOnly) ? 'none' : '1px solid #d1d5db' }}>
                            ...
                            if (layer.style?.useCardTheme) {
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="flex justify-between items-end w-full relative z-10 mt-2 pointer-events-none">
                            ...
                            return (
                                ...
                                >
                                    {layer.style?.showIcon !== false && (
                                        <svg className="w-5 h-5 shrink-0 transition-transform group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                                    )}
