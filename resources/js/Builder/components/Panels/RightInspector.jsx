                ...
                <div className="w-[320px] h-full flex flex-col overflow-hidden">
                    ...
                    {activeSection ? (
                        <div className="p-4 space-y-6 overflow-y-auto">
                            <div className="bg-primary-50 border border-primary-100 p-3 rounded-lg text-xs text-primary-800">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3 mt-2">
                    ...
                    <div className="pt-4 border-t border-gray-100">
                        ...
                        <div className="grid grid-cols-3 gap-2 mb-4">
                            <button onClick={() => alignLayer(activeLayer.id, 'left')} className={`flex flex-col items-center gap-1 p-2 border border-gray-200 rounded text-[10px] transition-colors ${Math.abs(activeLayer.style?.x || 0) < 2 ? 'bg-primary-50 text-primary-700 border-primary-200 shadow-sm' : 'hover:bg-gray-50 text-gray-600'}`}>
                                <svg className={`w-5 h-5 ${Math.abs(activeLayer.style?.x || 0) < 2 ? 'text-primary-600' : 'text-gray-500'}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="4" y1="2" x2="4" y2="22"></line><rect x="8" y="6" width="12" height="4" rx="1"></rect><rect x="8" y="14" width="8" height="4" rx="1"></rect></svg> Kiri
                            </button>
                            <button onClick={() => alignLayer(activeLayer.id, 'center')} className={`flex flex-col items-center gap-1 p-2 border border-gray-200 rounded text-[10px] transition-colors ${Math.abs((activeLayer.style?.x || 0) - (375 - (parseInt(activeLayer.style?.width) || 100)) / 2) < 2 ? 'bg-primary-50 text-primary-700 border-primary-200 shadow-sm' : 'hover:bg-gray-50 text-gray-600'}`}>
                                <svg className={`w-5 h-5 ${Math.abs((activeLayer.style?.x || 0) - (375 - (parseInt(activeLayer.style?.width) || 100)) / 2) < 2 ? 'text-primary-600' : 'text-gray-500'}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="2" x2="12" y2="22"></line><rect x="6" y="6" width="12" height="4" rx="1"></rect><rect x="8" y="14" width="8" height="4" rx="1"></rect></svg> Tengah
                            </button>
                            <button onClick={() => alignLayer(activeLayer.id, 'right')} className={`flex flex-col items-center gap-1 p-2 border border-gray-200 rounded text-[10px] transition-colors ${Math.abs((activeLayer.style?.x || 0) - (375 - (parseInt(activeLayer.style?.width) || 100))) < 2 ? 'bg-primary-50 text-primary-700 border-primary-200 shadow-sm' : 'hover:bg-gray-50 text-gray-600'}`}>
                                <svg className={`w-5 h-5 ${Math.abs((activeLayer.style?.x || 0) - (375 - (parseInt(activeLayer.style?.width) || 100))) < 2 ? 'text-primary-600' : 'text-gray-500'}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="20" y1="2" x2="20" y2="22"></line><rect x="4" y="6" width="12" height="4" rx="1"></rect><rect x="8" y="14" width="8" height="4" rx="1"></rect></svg> Kanan
                            </button>
                        </div>
    
                        <label className="text-xs font-bold text-gray-800 mb-3 block">Rata Vertikal</label>
                        <div className="grid grid-cols-3 gap-2 mb-3">
                            <button onClick={() => alignLayer(activeLayer.id, 'top')} className={`flex flex-col items-center gap-1 p-2 border border-gray-200 rounded text-[10px] transition-colors ${Math.abs(activeLayer.style?.y || 0) < 2 ? 'bg-primary-50 text-primary-700 border-primary-200 shadow-sm' : 'hover:bg-gray-50 text-gray-600'}`}>
                                <svg className={`w-5 h-5 ${Math.abs(activeLayer.style?.y || 0) < 2 ? 'text-primary-600' : 'text-gray-500'}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="2" y1="4" x2="22" y2="4"></line><rect x="6" y="8" width="4" height="12" rx="1"></rect><rect x="14" y="8" width="4" height="8" rx="1"></rect></svg> Atas
                            </button>
                            <button onClick={() => alignLayer(activeLayer.id, 'middle')} className={`flex flex-col items-center gap-1 p-2 border border-gray-200 rounded text-[10px] transition-colors ${Math.abs((activeLayer.style?.y || 0) - (844 - (parseInt(activeLayer.style?.height) || 100)) / 2) < 2 ? 'bg-primary-50 text-primary-700 border-primary-200 shadow-sm' : 'hover:bg-gray-50 text-gray-600'}`}>
                                <svg className={`w-5 h-5 ${Math.abs((activeLayer.style?.y || 0) - (844 - (parseInt(activeLayer.style?.height) || 100)) / 2) < 2 ? 'text-primary-600' : 'text-gray-500'}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="2" y1="12" x2="22" y2="12"></line><rect x="6" y="6" width="4" height="12" rx="1"></rect><rect x="14" y="8" width="4" height="8" rx="1"></rect></svg> Tengah
                            </button>
                            <button onClick={() => alignLayer(activeLayer.id, 'bottom')} className={`flex flex-col items-center gap-1 p-2 border border-gray-200 rounded text-[10px] transition-colors ${Math.abs((activeLayer.style?.y || 0) - (844 - (parseInt(activeLayer.style?.height) || 100))) < 2 ? 'bg-primary-50 text-primary-700 border-primary-200 shadow-sm' : 'hover:bg-gray-50 text-gray-600'}`}>
                                <svg className={`w-5 h-5 ${Math.abs((activeLayer.style?.y || 0) - (844 - (parseInt(activeLayer.style?.height) || 100))) < 2 ? 'text-primary-600' : 'text-gray-500'}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="2" y1="20" x2="22" y2="20"></line><rect x="6" y="4" width="4" height="12" rx="1"></rect><rect x="14" y="8" width="4" height="8" rx="1"></rect></svg> Bawah
                            </button>
                        </div>
                ...
                <div className="pt-4 border-t border-gray-100 space-y-4">
                    ...
                    <div className="border border-gray-200 rounded-lg overflow-hidden mb-4">
                        <div className="bg-gray-50 p-3 flex justify-between items-center border-b border-gray-200">
                            <label className="text-xs font-bold text-gray-700 flex items-center gap-2">
                                <svg className="w-4 h-4 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="4" ry="4" strokeWidth="2"></rect></svg>
                                Sudut Melengkung
                            </label>
                            <button 
                                ...
                                className={`w-8 h-4 rounded-full relative transition-colors ${activeLayer.style.borderRadius !== undefined ? 'bg-primary-600' : 'bg-gray-300'}`}
                            >
                            ...
                            <div className="p-3 space-y-4 bg-white">
                                <div>
                                    ...
                                    <div className="grid grid-cols-5 gap-1 border border-gray-200 rounded p-1 bg-gray-50 mb-1">
                                        <button title="Semua Sudut" onClick={() => updateLayerStyle(activeLayer.id, { borderRadiusType: 'all' })} className={`flex justify-center items-center py-1.5 rounded transition-colors ${(!activeLayer.style.borderRadiusType || activeLayer.style.borderRadiusType === 'all') ? 'bg-white shadow-sm text-primary-600 font-bold' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-200'}`}>
                                        ...
                                        <button title="Sudut Atas" onClick={() => updateLayerStyle(activeLayer.id, { borderRadiusType: 'top' })} className={`flex justify-center items-center py-1.5 rounded transition-colors ${activeLayer.style.borderRadiusType === 'top' ? 'bg-white shadow-sm text-primary-600 font-bold' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-200'}`}>
                                        ...
                                        <button title="Sudut Bawah" onClick={() => updateLayerStyle(activeLayer.id, { borderRadiusType: 'bottom' })} className={`flex justify-center items-center py-1.5 rounded transition-colors ${activeLayer.style.borderRadiusType === 'bottom' ? 'bg-white shadow-sm text-primary-600 font-bold' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-200'}`}>
                                        ...
                                        <button title="Sudut Kiri" onClick={() => updateLayerStyle(activeLayer.id, { borderRadiusType: 'left' })} className={`flex justify-center items-center py-1.5 rounded transition-colors ${activeLayer.style.borderRadiusType === 'left' ? 'bg-white shadow-sm text-primary-600 font-bold' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-200'}`}>
                                        ...
                                        <button title="Sudut Kanan" onClick={() => updateLayerStyle(activeLayer.id, { borderRadiusType: 'right' })} className={`flex justify-center items-center py-1.5 rounded transition-colors ${activeLayer.style.borderRadiusType === 'right' ? 'bg-white shadow-sm text-primary-600 font-bold' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-200'}`}>
                                    ...
                                    <div className="grid grid-cols-4 gap-1 border border-gray-200 rounded p-1 bg-gray-50">
                                        <button title="Sudut Kiri Atas" onClick={() => updateLayerStyle(activeLayer.id, { borderRadiusType: 'top-left' })} className={`flex justify-center items-center py-1.5 rounded transition-colors ${activeLayer.style.borderRadiusType === 'top-left' ? 'bg-white shadow-sm text-primary-600 font-bold' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-200'}`}>
                                        ...
                                        <button title="Sudut Kanan Atas" onClick={() => updateLayerStyle(activeLayer.id, { borderRadiusType: 'top-right' })} className={`flex justify-center items-center py-1.5 rounded transition-colors ${activeLayer.style.borderRadiusType === 'top-right' ? 'bg-white shadow-sm text-primary-600 font-bold' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-200'}`}>
                                        ...
                                        <button title="Sudut Kanan Bawah" onClick={() => updateLayerStyle(activeLayer.id, { borderRadiusType: 'bottom-right' })} className={`flex justify-center items-center py-1.5 rounded transition-colors ${activeLayer.style.borderRadiusType === 'bottom-right' ? 'bg-white shadow-sm text-primary-600 font-bold' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-200'}`}>
                                        ...
                                        <button title="Sudut Kiri Bawah" onClick={() => updateLayerStyle(activeLayer.id, { borderRadiusType: 'bottom-left' })} className={`flex justify-center items-center py-1.5 rounded transition-colors ${activeLayer.style.borderRadiusType === 'bottom-left' ? 'bg-white shadow-sm text-primary-600 font-bold' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-200'}`}>
                    ...
                    <div className="border border-gray-200 rounded-lg overflow-hidden">
                        <div className="bg-gray-50 p-3 flex justify-between items-center border-b border-gray-200">
                            <label className="text-xs font-bold text-gray-700 flex items-center gap-2">
                                <svg className="w-4 h-4 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 10h16M4 14h16M4 18h16"></path></svg>
                                Garis Tepi (Stroke)
                            </label>
                            <button 
                                onClick={() => updateLayerStyle(activeLayer.id, { 
                    ...
                    <div className="border border-gray-200 rounded-lg overflow-hidden">
                        <div className="bg-gray-50 p-3 flex justify-between items-center border-b border-gray-200">
                            <label className="text-xs font-bold text-gray-700 flex items-center gap-2">
                                <svg className="w-4 h-4 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
                                Gradasi Warna
                            </label>
                            <button 
                                onClick={() => {
                            ...
                            <div className="p-3 space-y-4 bg-white">
                                    ...
                                    <div className="p-2 border border-gray-100 rounded bg-gray-50">
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <input type="range" min="0" max="100" value={activeLayer.style.gradientStartOpacity ?? 100} onChange={(e) => updateLayerStyle(activeLayer.id, { gradientStartOpacity: parseInt(e.target.value) })} className="w-full h-1 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-primary-600" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="p-2 border border-gray-100 rounded bg-gray-50">
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <input type="range" min="0" max="100" value={activeLayer.style.gradientEndOpacity ?? 100} onChange={(e) => updateLayerStyle(activeLayer.id, { gradientEndOpacity: parseInt(e.target.value) })} className="w-full h-1 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-primary-600" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {activeLayer.style.backgroundType === 'linear-gradient' && (
                                    <div>
                                        ...
                                        <input type="range" min="0" max="360" value={activeLayer.style.gradientAngle ?? 90} onChange={(e) => updateLayerStyle(activeLayer.id, { gradientAngle: parseInt(e.target.value) })} className="w-full h-1.5 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-primary-600" />
                                    </div>
                                )}
                            </div>
                        )}
                    ...
                    <div className="border border-gray-200 rounded-lg overflow-hidden">
                        <div className="bg-gray-50 p-3 flex justify-between items-center border-b border-gray-200">
                            <label className="text-xs font-bold text-gray-700 flex items-center gap-2">
                                <svg className="w-4 h-4 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"></path></svg>
                                Drop Shadow
                            </label>
                            <button 
                            ...
                            <div className="p-3 space-y-4 bg-white">
                                <div>
                                    ...
                                    <div className="grid grid-cols-4 gap-2">
                                        {[
                                            ...
                                            { id: 'glow', name: 'Pendar', values: { shadowDistance: 0, shadowBlur: 15, shadowAngle: 0, shadowOpacity: 0.5, shadowColor: '#db2777', shadowSpread: 5 } },
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <input type="range" min="0" max="1" step="0.05" value={activeLayer.style.shadowOpacity ?? 0.5} onChange={(e) => updateLayerStyle(activeLayer.id, { shadowOpacity: parseFloat(e.target.value) })} className="w-full h-1.5 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-primary-600 mt-3" />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-3">
                                    <div>
                                        ...
                                        <input type="range" min="0" max="360" value={activeLayer.style.shadowAngle ?? 90} onChange={(e) => updateLayerStyle(activeLayer.id, { shadowAngle: parseInt(e.target.value) })} className="w-full h-1.5 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-primary-600" />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="range" min="0" max="100" value={activeLayer.style.shadowDistance ?? 0} onChange={(e) => updateLayerStyle(activeLayer.id, { shadowDistance: parseInt(e.target.value) })} className="w-full h-1.5 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-primary-600" />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="range" min="0" max="100" value={activeLayer.style.shadowBlur ?? 0} onChange={(e) => updateLayerStyle(activeLayer.id, { shadowBlur: parseInt(e.target.value) })} className="w-full h-1.5 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-primary-600" />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="range" min="-50" max="100" value={activeLayer.style.shadowSpread ?? 0} onChange={(e) => updateLayerStyle(activeLayer.id, { shadowSpread: parseInt(e.target.value) })} className="w-full h-1.5 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-primary-600" />
                                    </div>
                                </div>
                            </div>
                        )}
                            ...
                            return (
                                <div key={catIdx} className={catIdx > 0 ? "pt-6 border-t border-gray-100" : ""}>
                                    ...
                                    {!category.isContinuous && hasActiveAnimation && (animationMode === 'entry' ? activeLayer.animation?.entry : activeLayer.animation?.exit) && (
                                        <div className="mt-4 p-4 bg-gray-50/80 border border-primary-100 rounded-xl space-y-4">
                                            
                                            {/* Delay Config */}
                                            <div>
                                                <div className="flex justify-between items-center mb-1">
                                                    <span className="text-[10px] font-bold text-gray-700">Waktu Jeda (Delay)</span>
                                                    <span className="text-[10px] font-bold text-primary-600">{(animationMode === 'entry' ? activeLayer.animation.config?.delay : activeLayer.animation.configExit?.delay) || 0}s</span>
                                                </div>
                                                <input 
                                            ...
                                            <div>
                                                <div className="flex justify-between items-center mb-1">
                                                    ...
                                                    <span className="text-[10px] font-bold text-primary-600">{(animationMode === 'entry' ? activeLayer.animation.config?.speed : activeLayer.animation.configExit?.speed) || 1.5}s</span>
                                                </div>
                                                <input 
                                                        ...
                                                        {[
                                                            ...
                                                            return (
                                                                <button
                                                                    ...
                                                                    className={`p-2 text-sm font-bold border rounded-lg flex items-center justify-center transition ${isActiveDir ? 'border-primary-500 bg-primary-50 text-primary-700' : 'border-gray-200 text-gray-400 hover:border-primary-200 hover:bg-white'}`}
                                                                >
                                                                    {dir.icon}
                                                                </button>
                                                            );
                                        ...
                                        <div className="mt-4 p-4 bg-gray-50/80 border border-primary-100 rounded-xl space-y-4">
                                            {activeLayer.animation.idle === 'wind-sway' ? (
                                                <>
                                                    <div>
                                                        <div className="flex justify-between items-center mb-1">
                                                            ...
                                                            <span className="text-[10px] font-bold text-primary-600">{activeLayer.animation.configIdle?.windStrength ?? 70}%</span>
                                                        </div>
                                                        <input 
                                                    ...
                                                    <div>
                                                        <div className="flex justify-between items-center mb-1">
                                                            ...
                                                            <span className="text-[10px] font-bold text-primary-600">{activeLayer.animation.configIdle?.stiffness ?? 60}%</span>
                                                        </div>
                                                        <input 
                                                            type="range" min="0" max="100" step="1"
                                                    ...
                                                    <div>
                                                        <div className="flex justify-between items-center mb-1">
                                                            ...
                                                            <span className="text-[10px] font-bold text-primary-600">{activeLayer.animation.configIdle?.damping ?? 40}%</span>
                                                        </div>
                                                        <input 
                                                            type="range" min="0" max="100" step="1"
                                                ...
                                                <div>
                                                    <div className="flex justify-between items-center mb-1">
                                                        <span className="text-[10px] font-bold text-gray-700">Durasi (Kecepatan)</span>
                                                        <span className="text-[10px] font-bold text-primary-600">{activeLayer.animation.configIdle?.speed || 1}s</span>
                                                    </div>
                                                    <input 
                                                        type="range" min="0.1" max="5" step="0.1"
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        {(activeLayer.animation?.custom_keyframes || []).map((kf, index) => (
                                            <div key={kf.id} className="p-4 bg-white border border-gray-200 rounded-xl shadow-sm hover:border-primary-300 transition-all mb-3 relative overflow-hidden group">
                                                ...
                                                <div className="flex items-center justify-between mb-3 pl-2">
                                                    <span className="text-xs font-bold text-gray-800 flex items-center gap-2">
                                                        <div className="w-5 h-5 rounded-md bg-primary-100 text-primary-700 flex items-center justify-center text-[10px] shadow-inner">{index + 1}</div>
                                                        Titik {index + 1}
                                                    </span>
                                                    <div className="flex items-center gap-2">
                                                        <button 
                                                ...
                                                <div className="mt-3 pl-2 pt-3 border-t border-gray-100">
                                                    <div className="flex justify-between items-center mb-1">
                                                        ...
                                                        <span className="text-[10px] font-bold text-primary-600">{kf.delay || 0}s</span>
                                                    </div>
                                                    <input 
                                    ...
                                    {customMotionTab === 'path' && (
                                        <div className="space-y-4">
                                            {/* Info Box */}
                                            <div className="flex gap-3 bg-primary-50/80 p-3.5 rounded-xl border border-primary-100/50">
                                                ...
                                                <div className="text-[11px] text-primary-900/80 leading-relaxed">
                                                    <span className="font-bold block text-primary-900 mb-0.5">Animasi Jalur (Freehand)</span>
                                                ...
                                                <div className="mt-5 space-y-5 bg-white p-4 rounded-xl border border-gray-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
                                                    ...
                                                    <div>
                                                        <div className="flex justify-between items-center mb-2">
                                                            ...
                                                            <div className="bg-primary-50 text-primary-700 text-[10px] font-bold px-2 py-0.5 rounded-md border border-primary-100">
                                                                    ...
                                                                    >
                                                                        {isActive && (
                                                                            <div className="absolute top-1.5 right-1.5">
                                                                                <svg className="w-3 h-3 text-primary-600" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path></svg>
                                                                            </div>
                                                                        )}
                                                                        <div className={`w-8 h-8 mb-1.5 flex items-center justify-center rounded-lg transition-colors ${isActive ? 'bg-primary-100 text-primary-600' : 'bg-white text-gray-400 shadow-sm group-hover:text-gray-600'}`}>
                                                                            <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                                                                                {easeOption.icon}
                                                                            </svg>
                                                                        </div>
                                                                        <span className={`text-[9px] font-bold text-center leading-tight ${isActive ? 'text-primary-700' : 'text-gray-500 group-hover:text-gray-700'}`}>
                                                                            {easeOption.label}
                                                                        </span>
                                                                    </button>
                                                                );
                                            ...
                                            <div className="grid grid-cols-3 gap-3">
                                                {filters.map(filter => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <div className={`w-full aspect-square rounded-xl overflow-hidden border-2 transition-all ${isSelected ? 'border-primary-600 ring-2 ring-primary-200 shadow-md' : 'border-transparent group-hover:border-gray-300 bg-gray-50'}`}>
                                                                <img 
                                                            ...
                                                            <span className={`text-[10px] text-center font-medium leading-tight ${isSelected ? 'text-primary-600 font-bold' : 'text-gray-600'}`}>{filter.name}</span>
                                                        </div>
                                                    );
                                                })}
                                            </div>
                            ...
                            <div className="bg-gray-50 border border-gray-200 p-3 rounded-lg space-y-3">
                                ...
                                <div>
                                    <div className="flex justify-between items-center mb-1">
                                        ...
                                        <span className="text-[10px] font-bold text-primary-600">{activeLayer.style?.albumData?.speed || 500}ms</span>
                                    </div>
                                    <input 
                                ...
                                <div>
                                    <div className="flex justify-between items-center mb-1">
                                        ...
                                        <span className="text-[10px] font-bold text-primary-600">{(activeLayer.style?.albumData?.autoplayDelay || 2500) / 1000}s</span>
                                    </div>
                                    <input 
                            ...
                            <div className="space-y-4 pt-4 border-t border-gray-100">
                                <div>
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        ...
                                        >
                                            <svg className={`w-5 h-5 mb-1 ${activeLayer.interaction?.action === 'open_invitation' ? 'text-primary-600' : 'text-gray-500'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3 19v-8.93a2 2 0 01.89-1.664l7-4.666a2 2 0 012.22 0l7 4.666A2 2 0 0121 10.07V19M14 16a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                                            <span className={`text-[10px] text-center leading-tight ${activeLayer.interaction?.action === 'open_invitation' ? 'text-primary-700 font-bold' : 'text-gray-600'}`}>Buka Undangan</span>
                                        </button>
                                        ...
                                        >
                                            <svg className={`w-5 h-5 mb-1 ${activeLayer.interaction?.action === 'navigate' ? 'text-primary-600' : 'text-gray-500'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M19 14l-7 7m0 0l-7-7m7 7V3"></path></svg>
                                            <span className={`text-[10px] text-center leading-tight ${activeLayer.interaction?.action === 'navigate' ? 'text-primary-700 font-bold' : 'text-gray-600'}`}>Navigasi Scroll</span>
                                        </button>
                                        ...
                                        >
                                            <svg className={`w-5 h-5 mb-1 ${activeLayer.interaction?.action === 'trigger_animation' ? 'text-primary-600' : 'text-gray-500'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                                            <span className={`text-[10px] text-center leading-tight ${activeLayer.interaction?.action === 'trigger_animation' ? 'text-primary-700 font-bold' : 'text-gray-600'}`}>Picu Elemen</span>
                                        </button>
                                        ...
                                        >
                                            <svg className={`w-5 h-5 mb-1 ${activeLayer.interaction?.action === 'open_link' ? 'text-primary-600' : 'text-gray-500'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path></svg>
                                            <span className={`text-[10px] text-center leading-tight ${activeLayer.interaction?.action === 'open_link' ? 'text-primary-700 font-bold' : 'text-gray-600'}`}>Buka Tautan</span>
                                        </button>
                                    </div>
                                </div>
                                            ...
                                            {[
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <span className={`text-[9px] text-center leading-tight mt-1 ${isActive ? 'text-primary-700 font-bold' : 'text-gray-600'}`}>
                                                            {transition.label}
                                                        </span>
                                                    </button>
                                                );
                            ...
                            <div className="space-y-3 pb-4 border-b border-gray-100">
                                <div className="flex items-center justify-between sticky top-0 bg-white/90 backdrop-blur py-1 z-10 border-b border-gray-100">
                                    ...
                                    <label className="relative inline-flex items-center cursor-pointer">
                                        ...
                                        />
                                        <div className={`w-8 h-4 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-3 after:w-3 after:transition-all ${isRemovingBg ? 'opacity-50' : 'peer-checked:bg-primary-600'}`}></div>
                                    </label>
                                </div>
                                
                                {isRemovingBg && (
                                    <div className="bg-primary-50 border border-primary-100 rounded-xl p-4 flex flex-col items-center justify-center space-y-3 shadow-inner">
                                        <svg className="animate-spin h-6 w-6 text-primary-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                            <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                                            <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                        </svg>
                                        <div className="text-center">
                                            <p className="text-xs font-bold text-primary-800">Sedang Menghapus Latar...</p>
                                            <p className="text-[9px] text-primary-600 mt-1">AI sedang memproses gambar Anda. Proses ini memakan waktu beberapa detik.</p>
                                        </div>
                                    </div>
                                )}
                                        ...
                                        {filters.map(filter => (
                                            <React.Fragment key={filter.id}>
                                                ...
                                                >
                                                    ...
                                                    <span className={`text-[10px] text-center font-medium leading-tight ${activeLayer.style?.imageFilter === filter.id ? 'text-primary-600 font-bold' : 'text-gray-600'}`}>{filter.name}</span>
                                                </div>
                                                
                                                {/* Intensitas Slider di bawah item terpilih */}
                                                {activeLayer.style?.imageFilter === filter.id && filter.id !== 'none' && (
                                                    <div className="col-span-3 bg-gray-50 p-4 rounded-xl border border-primary-100 shadow-inner mt-1 mb-2 relative">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        <input 
                                            ...
                                            className="w-8 h-8 rounded cursor-pointer border-0 p-0"
                                        />
                                        <span className="text-[10px] font-mono text-gray-500">{activeLayer.style?.backgroundColor || '#db2777'}</span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        <input 
                                            ...
                                            className="w-8 h-8 rounded cursor-pointer border-0 p-0"
                                        />
                                        <span className="text-[10px] font-mono text-gray-500">{activeLayer.style?.iconColor || '#db2777'}</span>
                                    </div>
                                </div>
                                <div>
