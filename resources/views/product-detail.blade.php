            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-0 md:gap-8">
                ...
                <div class="lg:col-span-7 p-4 md:p-6 md:pl-0 flex flex-col">
                    ...
                    <div class="flex items-center text-sm text-gray-500 gap-4 mb-4 pb-4 border-b border-gray-100">
                        ...
                        @if(auth()->check())
                        <div class="flex items-center gap-1.5 bg-yellow-50 text-yellow-700 px-2 py-0.5 rounded text-xs font-medium border border-yellow-200" title="Hanya terlihat oleh Admin">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                            <span>{{ ($product->demo_views ?? 0) + ($product->total_invitation_views ?? 0) }} Views (Admin)</span>
                        </div>
                        @endif
                    </div>
